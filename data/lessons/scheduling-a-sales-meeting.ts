  ...
  vocabulary: [
    {
      ...
      example: 'Before suggesting any times, check what availability looks like on both sides — a shared calendar view in the airport lounge made it easy to spot the open slots.',
    ...
    },
    {
      ...
      example: 'There is one slot left on Tuesday afternoon — the salesperson pointed to it on the tablet calendar and asked if that time would work.',
    ...
    },
    {
      ...
      example: "The Wednesday slot still has a question mark against it — it is tentative until the full team confirms they can attend.",
    ...
    },
    {
      ...
      example: 'Something came up on Monday, so the viewing had to be rescheduled — the calendar showed the old slot crossed out with a red X and an arrow pointing to the new time.',
    ...
    },
    {
      ...
      example: 'A clear agenda was shared at the expo before the demo — platform overview, integration options, and onboarding path, each one ticked off in order as the conversation moved forward.',
    ...
    },
    {
      ...
      example: 'Once both sides agreed on the time, the appointment was confirmed with a green tick — a calendar invite followed within minutes to make it official.',
    ...
    },
    {
      ...
      example: 'The salesperson explained the duration upfront using a clock graphic — thirty minutes for the demo and fifteen for questions, so the client could block the right amount of time.',
    ...
    },
    {
      ...
      example: 'A calendar invite was sent to every member of the team at once — each person received a notification and the meeting landed in their diary automatically.',
  ...
  phrasalVerbs: [
    {
      ...
      example: 'Over a business lunch, the salesperson turned the tablet around to show a busy calendar and asked: what does your availability look like next week? — putting the client in control of the choice.',
    ...
    },
    {
      ...
      example: 'Would Thursday at 2pm work for you, or would Friday morning be better? — showing three calendar options on the tablet makes it easy for the client to pick without feeling pressured.',
    ...
    },
    {
      ...
      example: 'Before agreeing to anything, take a moment to let me check my calendar — scanning the week on a phone with the client watching avoids any double-booking.',
    ...
    },
    {
      ...
      example: "Once the time is agreed, lock it in straight away — I'll put that in the diary right now, so nothing else can take the slot.",
    ...
    },
    {
      ...
      example: 'A conflict came up, so the meeting needed to move — could we push that to 3pm instead? The calendar showed the new slot just one hour later with a simple arrow.',
    ...
    },
    {
      ...
      example: "As soon as the time was agreed, the invite was sent from a tablet and accepted on a phone with a green tick — I'll send a calendar invite to confirm puts both sides at ease.",
