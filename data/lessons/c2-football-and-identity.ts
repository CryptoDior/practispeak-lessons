...
export const c2FootballAndIdentity: Lesson = {
  ...
  vocabulary: [
    { word: 'IDENTITY', partOfSpeech: 'noun', definition: 'the set of qualities and beliefs that make a person or group who they are', example: '"For many fans, the club is central to their sense of identity."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'IDEOLOGY', partOfSpeech: 'noun', definition: 'a set of political or social beliefs that guide a group', example: '"Some clubs were founded with a clear political ideology — worker-owned and community-driven."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'TRIBALISM', partOfSpeech: 'noun', definition: 'very strong loyalty to your own group and hostility toward others', example: '"Football tribalism can bring people together or divide communities along old fault lines."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'EMBODY', partOfSpeech: 'verb', definition: 'to represent a quality or idea in a complete and clear way', example: '"Barcelona\'s style of play is said to embody Catalan identity and values."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'DIVISIVE', partOfSpeech: 'adjective', definition: 'causing disagreement or splitting a group into opposing sides', example: '"El Clasico is one of the most divisive fixtures in world sport."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'SOVEREIGNTY', partOfSpeech: 'noun', definition: 'full control or authority over something, especially a territory or institution', example: '"The debate over national football associations reflects broader questions of sovereignty."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'RITUAL', partOfSpeech: 'noun', definition: 'something done regularly that has social or symbolic meaning', example: '"The pre-match ritual of singing the anthem unites the crowd before kick-off."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { word: 'SOLIDARITY', partOfSpeech: 'noun', definition: 'unity and support among people who share something important', example: '"When the club faced financial crisis, fan solidarity kept it alive."', imageSlug: '/images/c2-football-and-identity-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'IDENTIFY WITH', definition: 'to feel a connection to a person, group, or set of values', example: '"Young players identify with clubs that reflect their community and background."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { phrase: 'STAND FOR', definition: 'to represent a set of values or beliefs', example: '"The club\'s crest and colors stand for more than just football — they stand for a city\'s history."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { phrase: 'GIVE RISE TO', definition: 'to cause or produce something', example: '"The rivalry gave rise to some of the most politically charged matches in history."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { phrase: 'GROW OUT OF', definition: 'to develop from something else over time', example: '"Modern football hooliganism grew out of economic frustration and political tension."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { phrase: 'PLAY INTO', definition: 'to support or strengthen an idea, often without intending to', example: '"The club\'s spending played into the narrative that money has destroyed the sport."', imageSlug: '/images/c2-football-and-identity-hero.png' },
    { phrase: 'LINE UP WITH', definition: 'to agree with or support a particular position or group', example: '"His public statements on club ownership lined up with what supporters had been calling for."', imageSlug: '/images/c2-football-and-identity-hero.png' },
  ],
  onThePitch: {
