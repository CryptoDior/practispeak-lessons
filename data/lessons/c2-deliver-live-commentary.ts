...
export const c2DeliverLiveCommentary: Lesson = {
  ...
  vocabulary: [
    { word: 'INTONATION', partOfSpeech: 'noun', definition: 'the rise and fall of your voice as you speak', example: '"His intonation rises at the moment of the shot — you know something is about to happen."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'CADENCE', partOfSpeech: 'noun', definition: 'the rhythm and flow of speech', example: '"The best commentators vary their cadence — slow and quiet for build-up, fast and loud for action."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'ANTICIPATE', partOfSpeech: 'verb', definition: 'to expect and prepare for what is about to happen', example: '"A great commentator can anticipate the shot half a second before the player takes it."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'EXCLAMATION', partOfSpeech: 'noun', definition: 'a word or phrase said suddenly with strong emotion', example: '"The exclamation at the moment of the goal is the most memorable moment in football audio."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'BREATHLESS', partOfSpeech: 'adjective', definition: 'speaking so fast and excitedly that you seem to barely stop for air', example: '"His breathless delivery in the final minutes created real urgency for the listener at home."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'TEMPO', partOfSpeech: 'noun', definition: 'the speed of speech or action', example: '"Raise the tempo of your commentary as the attack develops — the listener should feel the acceleration."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'BUILD-UP', partOfSpeech: 'noun', definition: 'a gradual increase in tension or excitement before a key moment', example: '"The build-up to a penalty is one of the most difficult moments to commentate well."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { word: 'SPONTANEOUS', partOfSpeech: 'adjective', definition: 'unplanned and natural — happening in the moment without preparation', example: '"The most memorable commentary lines are completely spontaneous — they cannot be scripted."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'RAMP UP', definition: 'to increase in speed or intensity', example: '"The commentary should ramp up as the team pushes for a late winner."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { phrase: 'HOLD BACK', definition: 'to wait and not give everything at once', example: '"Hold back during the build-up — save the energy for the shot."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { phrase: 'LET LOOSE', definition: 'to release full energy and emotion at the right moment', example: '"When the goal goes in, let loose — that is the moment the listener has been waiting for."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { phrase: 'PICK UP', definition: 'to increase in energy or pace', example: '"The commentary picks up as the player enters the box — the listener can feel something is coming."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { phrase: 'SLOW DOWN', definition: 'to reduce speed and create space for reflection', example: '"After the goal, slow down and let the emotion breathe — do not rush to the next thought."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
    { phrase: 'CUT AWAY', definition: 'to move suddenly to another moment or image', example: '"We cut away from the celebration to the manager\'s reaction on the touchline."', imageSlug: '/images/c2-deliver-live-commentary-hero.png' },
  ],
  onThePitch: {
