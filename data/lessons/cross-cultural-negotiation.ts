  ...
  vocabulary: [
    {
      ...
      example: "Riley briefed the team before the Tokyo meeting: This is a high-context communication environment. Marcus asked: What does that mean practically? Riley replied: It means the most important messages will often not be stated directly. A vague response to a proposal — 'that is an interesting idea' — may signal serious concern rather than enthusiasm. Silence after a question is not confusion — it is consideration, and it deserves more silence from you, not immediate clarification. Dana added: In a high-context culture, you read the room rather than the words. The energy in the room, the level of engagement, the hierarchy of who speaks and who does not speak — these tell you more than the explicit content of what is said. Going into a high-context negotiation with a low-context mindset — expecting everything important to be said explicitly — is a significant negotiation risk.",
    ...
    },
    {
      ...
      example: "Marcus reflected after the Amsterdam meeting: The Dutch team is very low-context. Everything they said was direct, explicit, and clearly stated — including the parts where they disagreed with us. Riley asked: Was that difficult? Marcus replied: It was initially jarring, but actually very efficient. When they said 'we do not think this approach will work,' they meant exactly that — not 'we are still considering it' or 'we have concerns.' Dana added: Low-context communication is often perceived as rude by people from high-context cultures, and as refreshingly clear by people who value directness. The key insight is that neither is objectively better — they are different communication norms that serve different functions. In a cross-cultural negotiation, recognising which style each party is operating in is the first step to avoiding serious misreading.",
    ...
    },
    {
      ...
      example: "Dana described the challenge: In our last negotiation with the Seoul team, they used indirect communication throughout. When we proposed the timeline, instead of saying no, they said 'the timeline would require some internal discussion.' Riley asked: What did that actually mean? Dana replied: It meant no. Or at minimum, significant concern. A direct culture partner would have said 'that timeline does not work for us.' An indirect culture partner signals the same thing, but in a way that allows both parties to save face and continue the relationship. Marcus added: The danger for a low-context communicator is interpreting indirect communication as vague agreement — 'they did not say no, so the answer must be yes.' That is the most common cross-cultural miscommunication in negotiations. You need to read indirect communication as the complete message it is, not as an invitation to clarify.",
    ...
    },
    {
      ...
      example: "Riley prepared the team: The most important concept to understand before this negotiation is face-saving. In this cultural context, publicly contradicting someone in a meeting — even politely, even correctly — causes them to lose face. Marcus asked: So how do we disagree? Riley replied: You disagree privately, indirectly, or through a trusted intermediary. If you disagree with something said in a meeting, you do not say so in front of the group. You wait for a break, approach the relevant person privately, and raise your concern in a way that allows them to revise their position without public acknowledgment. Dana added: Face-saving also applies to us. If we make a mistake in the negotiation, how we handle it matters. Admitting error openly and directly — which would be expected and respected in a low-context culture — can actually cause both parties to lose face in a high-context environment. The framing of how errors are acknowledged is as culturally specific as the errors themselves.",
    ...
    },
    {
      ...
      example: "Dana briefed the team on protocol for the Beijing meeting: Three things to know. Business cards are exchanged at the start of a meeting with both hands and a slight bow — not slipped into a pocket immediately. The most senior person in each delegation is introduced first and addressed by title rather than first name. And the agenda is typically not followed rigidly — the order of topics will shift based on the flow of conversation and the senior leadership's priorities. Riley asked: What happens if we violate the protocol accidentally? Dana replied: Most business partners in an international context are forgiving of inadvertent protocol errors from foreign counterparts — especially if you have clearly made an effort to understand and respect the cultural norms. What is not forgiven is the impression that you did not care enough to find out. Preparation signals respect in every culture.",
    ...
    },
    {
      ...
      example: "Marcus explained the decision-making dynamics: This partner organisation operates in a collectivist culture — which means the person in the room with us is unlikely to make a unilateral decision, even if they have the seniority to do so. Riley asked: How does that change our approach? Marcus replied: We cannot expect a yes or a no at the end of the meeting. We need to allow time for consensus-building within their organisation — the decision will be made collectively, internally, after consultation with parties who were not in the room. Dana added: The mistake a Western negotiator often makes in a collectivist culture context is interpreting the absence of an immediate decision as a lack of interest or authority. It is neither. It is a different decision-making process that respects the group's role. The respectful response is to provide clear information, avoid pressing for a quick answer, and allow the necessary time for internal consultation.",
    ...
    },
    {
      ...
      example: "Riley briefed the team on the Japanese partner's timeline: We should not expect a decision within the timeframe we have set. The Japanese organisation uses a consensus-building process called nemawashi — working through each relevant stakeholder group individually before a final decision is formalised. Marcus asked: How long does that typically take? Riley replied: For a decision of this significance, three to six weeks after our meeting. Possibly more. Dana added: The key is to provide everything they need to complete the consensus-building process effectively — clear documentation, answers to the likely questions from each stakeholder group, and no pressure for a faster timeline. The organisation that presses for a quick decision in a consensus-building culture is the organisation that does not get the partnership. Patience in this context is not weakness — it is cultural competence.",
    ...
    },
    {
      ...
      example: "Dana observed during the debrief: I picked up several non-verbal cues during the meeting that the words did not tell us. Riley asked: What specifically? Dana replied: Three things. First — the most senior person on their side stopped engaging with the presentation about 20 minutes in. He was looking at his phone and his body was slightly turned away from the table. In that cultural context, that is a significant signal of disinterest or concern that will not be expressed verbally. Second — the junior members of the team were watching him, not us, for cues about how to respond. Third — there was significantly less eye contact during the financial section than during the strategy section. Marcus added: The non-verbal signals told us a clearer story than the words did. The financial proposal needs revisiting. The words were politely receptive. The non-verbal cues were not.",
  ...
  phrasalVerbs: [
    {
      ...
      example: "Riley set the expectations before the debrief: We need to allow time for consensus-building — the decision will not come from today's meeting. Marcus was frustrated: But we agreed we needed a decision by the end of the month. Riley replied: That timeline may not be compatible with the way this organisation makes decisions. They will consult internally — probably with at least four different stakeholder groups — before they can give us a commitment. Pressing for a faster answer signals that we do not understand or respect their process, which will make the relationship harder, not easier. Dana added: The practical thing to do is to provide them with everything they need to complete the process efficiently — a written summary of our proposal, clear answers to the questions they are most likely to face internally, and a contact they can reach with follow-up questions. That accelerates consensus-building without pressuring it.",
    ...
    },
    {
      ...
      example: "Marcus debriefed after the negotiation: When I asked about the timeline, there was a long pause — at least 30 seconds. I started to explain myself again, which I now realise was wrong. Riley replied: The silence was not disagreement — it was consideration. In many East Asian negotiation contexts, silence after a question is a sign of respect and serious engagement. The counterpart is thinking carefully about what you asked and formulating a considered response. Dana added: The low-context communicator's instinct is to fill silence with more words — to clarify, to rephrase, to offer an alternative. But doing so in a high-context context interrupts the consideration process and can signal that you are impatient, that you do not trust the process, or that you are trying to push rather than invite. The correct response to silence in this context is more silence — and patience.",
    ...
    },
    {
      ...
      example: "Dana intervened when the negotiation stalled: Let us find a way forward that works for both sides — I want to understand what matters most to your team about the implementation timeline. Marcus watched and reflected: That phrase changed the whole dynamic. Riley explained: It did two things. First, it signalled that we are not adversarial — we are trying to find a solution together. In a high-context, relationship-oriented culture, that collaborative framing is very powerful. Second, it invited them to tell us what is actually important to them — which may not be what they have said explicitly. Dana added: The phrase also bought time. When a negotiation is stuck, restating the collaborative goal and asking an open question gives both sides a moment to reset without anyone losing face. No one has conceded anything. No one has made a demand. Both sides are just talking about what they need.",
    ...
    },
    {
      ...
      example: "Marcus paused the discussion: I want to make sure we are aligned before we go further — can you help me understand what you mean by 'provisional agreement' in this context? Riley thought later: That was exactly the right question. Dana explained: In some negotiation cultures, 'provisional agreement' on a point means 'agreed, subject to final review by leadership.' In others, it means 'we are noting this as a position to be revisited.' Marcus had noticed that the two teams were using the term differently, and rather than proceeding as if they were aligned, he checked. Riley: The risk of not checking is that you build a whole subsequent negotiation on an apparent agreement that the other party did not actually make. By the end, you have two completely different documents and no idea where the misalignment entered the conversation.",
    ...
    },
    {
      ...
      example: "Riley prepared the team for the São Paulo meeting: The relationship needs to come before the contract — in this culture, the deal is built on the relationship, not the other way round. Marcus asked: How long does that take? Riley replied: Longer than you want it to. The first meeting is not about the terms. It is about building the human connection that makes the terms possible. Questions about your family, your interests, your history — these are not small talk, they are the foundation of business trust. Dana added: Western businesspeople often arrive at a first meeting with a full agenda, a slide deck, and a timeline for a decision. In many Latin American and Middle Eastern contexts, arriving with that mindset signals that you value the deal more than the relationship — which is the exact opposite of what you want to communicate. The agenda comes later. The relationship comes first.",
    ...
    },
    {
      ...
      example: "Marcus proposed challenging the counterpart's data directly in the meeting. Dana intervened: We should avoid putting them in a position where they lose face — instead, we raise the concern privately, after the meeting, with the person who is most trusted to relay it. Riley explained: If you contradict their data publicly — even politely, even correctly — you are asking their lead negotiator to acknowledge being wrong in front of their team. That is a significant loss of face. The correction will not be welcomed regardless of how diplomatically it is made. Marcus asked: So how do we address the data issue? Dana replied: We request a follow-up call tomorrow. We raise the data point as 'something we want to make sure we have correctly understood' — not as a correction but as a clarification. That framing allows the counterpart to provide the correct figure without having been publicly wrong.",
