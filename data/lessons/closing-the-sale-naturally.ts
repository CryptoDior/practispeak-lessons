...
export const closingTheSaleNaturally: Lesson = {
  ...
  vocabulary: [
    ...
    },
    {
      word: 'TRIAL CLOSE',
      partOfSpeech: 'phrase',
      definition: "A soft question used to test whether the buyer is ready to commit before asking for the formal close. A trial close reveals how the buyer is feeling without the pressure of a direct ask. Example: 'How are you feeling about everything we've covered?'",
      example: "Riley used a trial close before asking for the signature: Based on everything we've discussed today, how are you feeling about the platform? Marcus replied: I think we're very close — the team likes what they saw. That told Riley it was time to close.",
    ...
    },
    {
      word: 'NEXT STEP',
      partOfSpeech: 'phrase',
      definition: "The agreed action after a sales conversation — a specific, time-bound commitment to move forward. 'Let's agree on next steps' is the phrase that turns a verbal yes into a concrete plan: who will do what, and by when.",
      example: "Riley closed the call by agreeing on clear next steps: So — I'll send the contract today, you'll share it with finance and legal by Wednesday, and we'll aim to have it signed by Friday. Does that timeline work? Always leave a sales call with a specific next step.",
  ...
  phrasalVerbs: [
    {
      ...
      definition: "The core language focus of this lesson — a confident, professional, assumptive close. 'Shall we' is softer and more collaborative than 'Will you' — it implies a shared decision, not a demand. Always follows 'Shall we move forward?' with the specific next step.",
      example: "Riley said: Based on everything we've covered — the platform, the case study, the commercial terms — shall we move forward? I can have the contract ready to send today if you'd like to confirm.",
      imageSlug: '/images/shall-we-move-forward.png',
    },
    {
      phrase: "BASED ON EVERYTHING WE'VE COVERED, HOW ARE YOU FEELING?",
      definition: "The standard trial close phrase — it invites the buyer to share their overall impression before you ask for the commitment. 'How are you feeling?' is more open than 'Are you ready?' — it makes the buyer feel heard, not pressured.",
      example: "Riley said: Marcus, we've had four conversations over the past few weeks. Based on everything we've covered — the platform, the case study, the terms — how are you feeling about everything? His answer told her exactly where the hesitation was.",
      imageSlug: '/images/based-on-everything-weve-covered-how-are-you-feeling.png',
    },
    {
      phrase: 'IS THERE ANYTHING STILL HOLDING YOU BACK?',
      definition: "The phrase for uncovering final objections before the close. 'Holding you back' is natural and non-confrontational — it implies that the buyer wants to move forward but something is stopping them, which is almost always true at the close stage.",
      example: "Riley asked: Is there anything still holding you back that we haven't addressed? Marcus mentioned the legal review. Without that question, Riley would have left the call without knowing the final obstacle — and might have lost the deal.",
    ...
    },
    {
      ...
      definition: 'A more analytical close question — useful when the buyer is vague about their hesitation. It forces them to articulate exactly what is missing, which gives you something specific to address.',
      example: "Riley asked: What would need to be true for you to feel confident moving forward this week? Marcus said: I need to know the implementation timeline won't affect our current quarter. That gave Riley something specific to answer.",
    ...
    },
    {
      ...
      definition: "The assumptive next step — it moves directly from checking satisfaction to proposing action. 'If you're happy' is a low-pressure conditional. 'I can send the contract today' creates gentle urgency without demanding an immediate signature.",
      example: "Riley said: If you're happy with everything we've discussed, I can send the contract over today. That gives your legal team the week to review it, and we can aim for a signature by Friday. Does that timeline work?",
      imageSlug: '/images/if-youre-happy-with-everything-i-can-send-the-contract-today.png',
    },
    {
      phrase: "LET'S AGREE ON NEXT STEPS",
      definition: 'The closing phrase that turns a verbal yes into a concrete plan. Used at the end of every sales call — regardless of whether a full commitment was reached. Always close with a specific action, a name, and a date.',
      example: "Riley said: Let's agree on next steps before we hang up. I'll send the contract and the finance summary today. You'll share both with your team by Wednesday. And we'll speak again on Friday to confirm. Does that work? — Always leave with a plan.",
