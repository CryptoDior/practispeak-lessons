...
export const c2GreatFootballThinkers: Lesson = {
  ...
  vocabulary: [
    { word: 'PARADIGM', partOfSpeech: 'noun', definition: 'a model or example that others follow or build on', example: '"Total Football was a paradigm that changed how coaches thought about attacking play."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'ORTHODOXY', partOfSpeech: 'noun', definition: 'the normal, accepted way of doing things', example: '"Sacchi challenged the orthodoxy that Italian football had to be defensive first."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'LEGACY', partOfSpeech: 'noun', definition: 'what someone leaves behind — the lasting effect of their work', example: '"Cruyff\'s legacy is visible in the way Barcelona still play today."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'PHILOSOPHY', partOfSpeech: 'noun', definition: 'a set of ideas and beliefs that guide how you do something', example: '"His philosophy was simple: if you have the ball, the opponent cannot score."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'DISRUPTIVE', partOfSpeech: 'adjective', definition: 'something that breaks the normal way things work in a big way', example: '"Guardiola\'s use of a false nine was disruptive — defenders had no one to mark."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'DISSECT', partOfSpeech: 'verb', definition: 'to examine something in close detail', example: '"Analysts still dissect Sacchi\'s pressing system to understand how it worked so well."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'ADVOCATE', partOfSpeech: 'noun / verb', definition: 'someone who argues strongly for an idea, or to argue for it', example: '"Cruyff was a strong advocate for youth development and technical football."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { word: 'RADICAL', partOfSpeech: 'adjective', definition: 'very different from what people normally think or do', example: '"The idea that defenders should join the attack was radical in the 1970s."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'BREAK WITH', definition: 'to stop following tradition or the accepted way of doing things', example: '"Sacchi broke with Italian tradition by prioritising the press over man-marking."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { phrase: 'BUILD ON', definition: 'to use something as a foundation for something new', example: '"Guardiola built on Cruyff\'s ideas and developed them further at Barcelona."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { phrase: 'SET OUT', definition: 'to explain a plan or idea clearly at the beginning', example: '"In his interviews, Cruyff always set out his thinking in simple, direct terms."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { phrase: 'DRAW ON', definition: 'to use knowledge or ideas from a source', example: '"Guardiola draws on Sacchi\'s pressing ideas when designing his defensive structure."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { phrase: 'STAND FOR', definition: 'to represent or believe in a set of values', example: '"For Cruyff, Total Football stood for creativity, freedom, and intelligence."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
    { phrase: 'GO AGAINST', definition: 'to oppose or challenge something accepted', example: '"Their attacking style went against everything Italian football stood for at the time."', imageSlug: '/images/c2-great-football-thinkers-hero.png' },
  ],
  onThePitch: {
