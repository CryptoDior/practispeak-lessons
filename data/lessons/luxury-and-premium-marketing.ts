  ...
  vocabulary: [
    {
      ...
      example: "Riley presented the brand positioning: The new campaign is deliberately aspirational — it does not show a product. It shows a way of living. Marcus asked: Is that not too vague? Riley replied: For a luxury brand, aspiration is the point. The product is almost incidental. What the campaign sells is the feeling of arriving — the table at the restaurant, the hotel suite, the coat in the right city at the right moment. Dana added: And aspirational does not mean unattainable. The best aspirational marketing creates a feeling of possibility — if you work hard enough, if you make the right choices, this world is within reach. That tension between desire and possibility is what makes aspirational marketing so effective. If it feels completely out of reach, people disengage. If it feels just within reach, they lean in.",
    ...
    },
    {
      ...
      example: "Marcus explained the distribution strategy: We are reducing the number of retail stockists from 200 to 40 next year. Dana asked: That will reduce sales volume — why? Marcus replied: Because exclusivity is the product. Right now the brand is available in too many places, at too many price points, through too many channels. The customer who buys our bag at a department store sale is not the customer we are building the brand for. Reducing distribution increases desirability among the customers who matter. Riley added: And the customers who already own the brand will value it more knowing that fewer people will have access. Exclusivity is not about keeping people out — it is about making access feel meaningful. When everyone has it, no one values it.",
    ...
    },
    {
      ...
      example: "Dana reviewed the brand book: The heritage story is the foundation of everything. Riley asked: What is the heritage story for this brand specifically? Dana replied: Founded in 1847 in Lyon. Three generations of the same family. The original atelier still exists — it is now a museum and working studio. Every piece carries a serial number that traces back to the specific artisan who made it. Marcus added: That is not just history — that is provenance. When a customer buys this product, they are buying a connection to a lineage of excellence that has been consistent for 175 years. No marketing campaign can manufacture that. The heritage is the product's most valuable attribute — and every piece of communication should reference it, because it is the one thing no competitor can replicate.",
    ...
    },
    {
      ...
      example: "Riley described the product story: The craftsmanship story for this collection is exceptionally strong. Each jacket takes 40 hours to make. Three different craftspeople work on a single garment — a cutter, a tailor, and a finisher. The fabric is woven in a mill that has been operating for 120 years. Marcus asked: Is the customer expected to know all of this? Riley replied: Not all of it — but they should feel it. The weight of the fabric, the way the seams lie, the precision of the lining. Craftsmanship is experienced before it is understood. Dana added: And the story behind the craftsmanship gives the customer the vocabulary to explain their purchase to other people. 'I bought this because it is beautiful' is a feeling. 'I bought this because 40 hours of work went into it by three artisans using 120-year-old fabric' is a narrative. Luxury customers want the narrative.",
    ...
    },
    {
      ...
      example: "Marcus presented the portfolio strategy: We are launching an ultra-premium tier above our existing luxury line. Riley asked: What defines the line between luxury and ultra-premium for us? Marcus replied: Three things. First — price: this tier starts at three times the existing luxury entry price. Second — availability: maximum 500 units per year, globally. Third — access: purchases require an existing client relationship or a referral. Dana added: Ultra-premium also requires a different retail experience. You cannot sell it through the standard channel. The ultra-premium client expects a private viewing, a personal relationship with a house representative, and a level of service that reflects the investment they are making. The product is almost secondary to the experience of acquiring it.",
    ...
    },
    {
      ...
      example: "Dana explained the launch strategy: We are releasing only 200 units at launch. Marcus asked: Why limit supply when demand is clearly there? Dana replied: Because scarcity is a positioning tool, not a supply problem. We could make 2,000. We are choosing to make 200. The customer who acquires one of those 200 units has something genuinely rare — and they know it. Riley added: The waitlist is not a failure of distribution. The waitlist is a marketing asset. It signals that demand exceeds supply. It creates a story — 'I have been waiting six months for this.' That story is more powerful than any ad we could buy. And when the next collection launches, the customer who waited for the first one is the most motivated buyer in the market. Scarcity creates loyalty through anticipation.",
    ...
    },
    {
      ...
      example: "Riley presented the brand health data: Brand desirability is our most important metric this year — above awareness, above consideration, above purchase intent. Marcus asked: Why? Riley replied: Because for a luxury brand, desirability is the engine of everything else. If people desire the brand, they will seek it out, they will wait for it, they will tell others about it. If they merely prefer it over alternatives, they will switch when something better comes along. Dana added: Brand desirability is also what allows us to maintain price. A brand that people desire does not need to discount — the desire justifies the price. A brand that people merely like has to work much harder to hold its price point when a competitor offers something similar for less. Desirability is the ultimate premium brand asset.",
    ...
    },
    {
      ...
      example: "Dana outlined the seeding strategy: We are not targeting mass media for this launch. We are seeding the product with connoisseurs — collectors, critics, and category experts — and letting them shape the narrative. Marcus asked: Will that reach a wide enough audience? Dana replied: A connoisseur recommends with authority. When an expert says 'this is exceptional' — in a column, a podcast, a private conversation — it carries far more weight than any advertising we can buy. Riley added: And connoisseurs attract connoisseurs. The brands that serious collectors discuss become the brands that aspirational collectors discover. You build desirability from the inside out — start with the people who know most, and let their judgment radiate outward. Mass advertising builds awareness. Connoisseur endorsement builds credibility, and credibility is harder to buy.",
  ...
  phrasalVerbs: [
    {
      ...
      example: "Marcus was firm in the review: The brand should never discount. Riley pushed back: But we have excess stock from last season and the holding cost is significant. Marcus replied: I understand the short-term pressure. But the brand should never discount — it signals that we misjudged demand, that the product is available to anyone at any price point, and that the customer who paid full price was wrong to do so. That last signal is the most damaging. Dana added: There are other ways to move excess stock. A private sale to existing clients by invitation only. A product gifted to a charity auction. A partnership where the product is offered as a prize, not a discount. None of these involve marking down the public price. The moment a luxury brand discounts publicly, it destroys a piece of desirability that takes years to rebuild. That piece of desirability is worth far more than the revenue from the sale.",
    ...
    },
    {
      ...
      example: "Dana presented to the retail partners: I want to address the question that has come up from several of you about supply levels. Scarcity is a positioning tool, not a supply problem — we are choosing to produce 500 units per season because that is the number that maintains the desirability and the exclusivity that makes your customers want it. Riley added: If we scaled production to meet all demand, we would increase short-term revenue and reduce long-term brand value. The customer who cannot get it today becomes the customer most motivated to return for next season. Marcus added: And the retailer who tells a customer 'I am sorry, we only have two left' is giving that customer one of the most powerful luxury purchase justifications in existence — 'I was lucky to get one.' Scarcity makes ownership feel like an achievement. That feeling is the product.",
    ...
    },
    {
      ...
      example: "Riley briefed the creative agency: I want to be clear about what this campaign is for. We are selling a feeling, not a product — the campaign should not show specifications, features, or even close-up product shots. Marcus asked: Then what should it show? Riley replied: A world. The light in a room at a particular time of day. A person who has arrived somewhere — not geographically but in life. The texture of a moment. The campaign should make someone feel something and then, quietly, connect that feeling to the brand. Dana added: The product appears in the campaign the way it appears in real life for this customer — not as the hero, but as part of the story. A bag on a chair in a beautiful room. A coat worn by someone whose life you want. The product earns its place in the image; it does not dominate the image.",
    ...
    },
    {
      ...
      example: "Marcus addressed the strategy review: We have competitors with larger budgets, wider distribution, and faster production. What they do not have is our heritage story. Riley asked: How do we communicate it without sounding nostalgic or outdated? Marcus replied: The heritage story is the competitive advantage — no one can replicate 150 years of history, three generations of a founding family, and an atelier that still operates in the same building. Dana added: The key is to frame the heritage as proof of the future, not as a story about the past. 'We have been making this since 1874' is about the past. 'Because we have been making this since 1874, we know things about this craft that no brand founded in the last decade can know' — that is about the present advantage. Heritage is not nostalgia. Heritage is expertise accumulated over generations, and expertise is a very contemporary competitive advantage.",
    ...
    },
    {
      ...
      example: "Dana led the brand audit: Ultra-premium requires restraint in every touchpoint — from the weight of the packaging to the font size on the label to the way the assistant speaks on the telephone. Marcus asked: What do you mean by restraint specifically? Dana replied: No exclamation marks. No superlatives used carelessly. No call-to-action language that creates urgency or pressure. No sale. No limited-time offers. No language that suggests the customer might miss out — the ultra-premium customer is not motivated by fear of missing out, they are motivated by confidence in their own taste. Riley added: Restraint also means silence. The ultra-premium brand does not advertise everywhere. It appears where it should appear and is absent everywhere else. That absence is as intentional as the presence. A brand that is visible everywhere cannot be exclusive. Restraint is the visual, verbal, and commercial expression of confidence.",
    ...
    },
    {
      ...
      example: "Marcus raised the concern at the partnership review: The collaboration with the streetwear brand is interesting commercially, but this collaboration risks diluting the luxury positioning unless we control the execution with absolute precision. Riley asked: What would control look like? Marcus replied: Our aesthetic leads, not theirs. Our quality standards apply to every product in the collection. The pricing stays in our range, not theirs. And the distribution is through our channels only — not through theirs. Dana added: Even then, I have a concern. The streetwear audience and our audience have different expectations. If our existing customers see the collaboration and feel that the brand has become accessible to an audience they did not expect to share it with, we lose something that is very hard to get back. The collaboration has to elevate us — not extend us into a new market. If the brand is seen as chasing reach, the existing brand equitiy takes the hit.",
