...
export const robloxDescribingMyAvatar: Lesson = {
  ...
  irlVocabulary: [
    ...
    },
    {
      word: 'BRIGHT',
      partOfSpeech: 'adjective',
      definition: "A very strong, vivid colour that catches your eye immediately.",
    ...
    },
    {
      ...
      example: "Your appearance at a job interview is important — dress neatly and look confident.",
      imageSlug: '/images/roblox-describing-my-avatar-appearance-irl.png',
    },
    {
      word: 'UNIQUE',
      partOfSpeech: 'adjective',
      definition: "One of a kind — not like anyone or anything else. Special and original.",
  ...
  phrasalVerbs: [
    ...
    },
    {
      ...
      inRealLife: "Describe yourself in English — practice saying what you look like out loud.",
