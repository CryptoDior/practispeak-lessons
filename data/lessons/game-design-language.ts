...
export const gameDesignLanguage: Lesson = {
  slug: 'game-design-language',
  title: 'Game Design Language',
  subtitle:
    'How designers actually talk about their work — iteration, scope, and the quiet authority of the passive voice',
  level: 'C1-C2',
  description:
