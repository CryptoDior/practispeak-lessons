  ...
  vocabulary: [
    {
      ...
      example: "A strategic recap doesn't just document what was said — it connects what was discussed back to the buyer's original priorities.",
    ...
    },
    {
      ...
      example: "A well-timed value reminder reconnects a drifting conversation back to the specific outcome the buyer originally said they wanted.",
    ...
    },
    {
      ...
      example: "The goal of decision support is to give the buyer everything they need to make the case internally — without you being in the room.",
    ...
    },
    {
      ...
      example: "Effective reengagement is tied to something genuinely relevant — a new result or a development the buyer didn't know about.",
    ...
    },
    {
      ...
      example: "Multi-threading means you're not dependent on one person — if your main contact loses attention, the deal doesn't die with them.",
    ...
    },
    {
      ...
      example: "Stalled deals drag down pipeline velocity — identifying which stage they're stuck at is the first step to moving them forward.",
    ...
    },
    {
      ...
      example: "Every touch point in a follow-up sequence should give the buyer something useful — a new result, a relevant question, or a piece of decision support.",
    ...
    },
    {
      ...
      example: "Deal risk often shows up quietly — a champion going silent, a budget freeze, or a competitor getting access to someone you've never spoken to.",
  ...
  phrasalVerbs: [
    {
      ...
      example: "Following our conversation on Wednesday, I wanted to send a brief recap of the three things we agreed on and flag the one open question we still need to resolve.",
    ...
    },
    {
      ...
      example: "I'm not reaching out to push — I just wanted to share a couple of resources that might make the internal approval process a bit easier to navigate.",
    ...
    },
    {
      ...
      example: "Based on what you shared last time about the pressure on delivery timelines, I thought this case study would be directly relevant to where you are right now.",
    ...
    },
    {
      ...
      example: "I've put together a one-page summary covering the key return figures, the risk mitigation provisions, and the proposed implementation timeline — everything in one place for the decision conversation.",
    ...
    },
    {
      ...
      example: "Since we last spoke, a client in a comparable position completed their first quarter of rollout and saw a 28% improvement in the metric they'd flagged as their biggest concern.",
    ...
    },
    {
      ...
      example: "I don't want to lose momentum — can we agree on a specific next step now, including a date and what we'd each want to have ready by then?",
