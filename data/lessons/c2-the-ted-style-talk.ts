...
export const c2TheTedStyleTalk: Lesson = {
  ...
  vocabulary: [
    { word: 'RHETORIC', partOfSpeech: 'noun', definition: 'the art of using language to persuade or influence an audience', example: '"His rhetoric was powerful — every sentence seemed to build toward a single, inevitable conclusion."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'ANAPHORA', partOfSpeech: 'noun', definition: 'repeating the same word or phrase at the start of several sentences in a row', example: '"The speech used anaphora — each sentence began with the same word, building to an unforgettable conclusion."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'THESIS', partOfSpeech: 'noun', definition: 'the main argument or central claim of a talk or essay', example: '"State your thesis early — the audience needs to know what you are arguing before you argue it."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'CONVICTION', partOfSpeech: 'noun', definition: 'a strong, deep belief in something — which comes through in how you say it', example: '"She delivered her argument with such conviction that the room was silent when she finished."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'RESONANCE', partOfSpeech: 'noun', definition: 'the quality of an idea or phrase that makes it feel meaningful and lasting', example: '"The best TED talks have resonance — you are still thinking about them days later."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'PIVOT', partOfSpeech: 'noun / verb', definition: 'a sudden change in direction — in an argument, moving to a new or unexpected point', example: '"After establishing the problem, he pivoted to the solution — and the audience leaned forward."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'PROVOKE', partOfSpeech: 'verb', definition: 'to make people think or feel something strongly — to stir the audience', example: '"A great opening should provoke — it should make the audience question something they thought they knew."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { word: 'CALLBACK', partOfSpeech: 'noun', definition: 'a reference back to an earlier image, phrase, or idea in the same talk', example: '"The callback to the opening story gave the talk a beautiful sense of completeness."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'OPEN WITH', definition: 'to begin a talk with a specific device — a story, question, or image', example: '"Open with a story, not a statistic — people remember narratives, not numbers."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { phrase: 'BUILD TO', definition: 'to gradually increase toward the most powerful moment', example: '"The talk builds to a single, unforgettable conclusion — everything before it is preparation."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { phrase: 'LAND ON', definition: 'to arrive at the main point or conclusion', example: '"After the pivot, land on your thesis clearly — do not bury it in qualifications."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { phrase: 'WIN OVER', definition: 'to persuade someone to agree with you', example: '"By the third minute, she had won over the audience — they were completely with her."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { phrase: 'CALL BACK TO', definition: 'to refer to something said earlier in the same talk', example: '"In the conclusion, call back to the opening image — it gives the talk a sense of completeness."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
    { phrase: 'WRAP UP', definition: 'to bring the talk to a satisfying close', example: '"Wrap up with one clear sentence — the single thought you want them to take away."', imageSlug: '/images/c2-the-ted-style-talk-hero.png' },
  ],
  onThePitch: {
    ...
    items: [
      ...
      { cue: 'Pause for effect', meaning: 'Deliberate silence after a key statement — giving it space and weight.', usage: '"He said that football had saved his life. Then he paused for five seconds. Nobody in the room breathed."', imageSlug: 'otp-ted' },
