  ...
  vocabulary: [
    {
      word: 'QUOTA',
      partOfSpeech: 'noun',
      definition: 'The revenue target assigned to a salesperson or team for a defined period — typically a quarter or a financial year. Quota is the foundational metric of individual sales performance: a rep at 100% of quota has closed exactly their assigned target; a rep at 120% has over-delivered. Quota-setting involves balancing historical performance, market opportunity, and organisational growth targets.',
      example: "Riley said to Jordan: Your quota for Q3 is £320,000 — that's a 15% increase on Q2 attainment, which reflects both the growth in your territory and the maturity of your pipeline. I want to be transparent about how we got to that number: £200,000 represents the baseline expectation from accounts in your territory, and the remaining £120,000 represents your stretch — three new logos at average deal size.",
      imageSlug: '/images/quota.png',
    },
    {
      word: 'ATTAINMENT',
      partOfSpeech: 'noun',
      definition: 'The percentage of quota achieved by a salesperson or team in a given period — the primary metric of sales performance. A rep at 120% attainment has closed 120% of their assigned quota. Attainment is typically reviewed at quarter-end, but tracking in-period attainment allows managers and reps to identify risk and adjust behaviour before the quarter closes.',
      example: "Riley reviewed the team's performance: Jordan, at the midpoint of Q3, your attainment is 58% of quota. That sounds below target, but the pipeline coverage is 3.8x — which means if the top four deals close as expected, you'll land at around 115%. The risk I want to explore is that three of those four deals have been in the pipeline for more than 60 days without a clear next step. That's what we need to address today.",
      imageSlug: '/images/attainment.png',
    },
    {
      word: 'COACHING',
      partOfSpeech: 'noun',
      definition: "In sales leadership, the ongoing process of developing a rep's judgement, skills, and self-awareness through questioning, observation, and structured reflection — rather than through instruction or direction. The most effective coaching conversations ask questions that help the rep discover the right answer rather than providing the answer directly, building capability that transfers to future situations.",
      example: "Riley's coaching philosophy was explicit: My job in pipeline reviews is not to tell you what to do. It's to help you think better about what you're doing. Every question I ask is designed to surface something you already know but haven't yet applied. If I tell you to call the champion by Thursday, you'll call the champion by Thursday. If I help you understand why calling the champion by Thursday matters, you'll start making that decision yourself.",
      imageSlug: '/images/coaching.png',
    },
    {
      word: 'PIPELINE COVERAGE',
      partOfSpeech: 'phrase',
      definition: "The ratio of the total value of deals in a rep's pipeline to their quota — a key health metric for predicting whether a rep will make their number. A pipeline coverage of 3x means the rep has three times their quota in active opportunities. Healthy coverage ratios vary by industry and deal complexity, but 3x to 4x is a common standard in B2B enterprise sales.",
      example: "Riley explained the coverage concern: Jordan's headline coverage is 3.8x — which looks healthy. But when I strip out the three deals that have been stuck for more than 60 days without a defined next step, effective coverage drops to 2.1x. That's below the threshold for confidence at this stage of the quarter. We need to either unstick those deals or replace them with qualified pipeline before mid-quarter.",
      imageSlug: '/images/pipeline-coverage.png',
    },
    {
      word: 'FORECAST',
      partOfSpeech: 'noun',
      definition: "A prediction of the revenue expected to close in a given period — typically categorised by confidence level: commit (deals the rep is certain will close), best case (deals that could close with a positive outcome), and upside (stretch deals that are possible but not expected). Forecasting accuracy is a critical skill for sales leaders, whose own commitments to senior leadership are based on aggregating their team's forecasts.",
      example: "Riley asked Jordan: What are you committing to the forecast this quarter? Not best case — what is your commit number? The number you'd stake your credibility on, that you'd be confident telling me will close regardless of how the next eight weeks play out. I need that number to be accurate, because my commit to the VP is the sum of eight forecasts, and one that's 40% wrong at the rep level creates a problem at the leadership level.",
      imageSlug: '/images/forecast.png',
    },
    {
      word: 'DEAL RISK',
      partOfSpeech: 'phrase',
      definition: "Any factor that makes a specific deal less likely to close on time or at the expected value — including missing stakeholders, an absent champion, no agreed next step, a competitor gaining ground, or a change in the buyer's internal priorities. In a pipeline review, surfacing deal risk is the primary analytical task: the manager is looking for the difference between what the rep says and what the deal's actual behaviour suggests.",
      example: "Riley named the deal risk directly: Jordan, the deal has been in 'negotiation' stage for 47 days. The last logged activity was a call three weeks ago with no recorded next step. In my experience, that's not a deal that's progressing quietly — that's a deal that's stalling. The question is whether the stall is visible and being managed, or whether it's a slow fade that neither party has explicitly acknowledged yet.",
      imageSlug: '/images/deal-risk.png',
    },
    {
      word: 'RAMP',
      partOfSpeech: 'noun',
      definition: "The period of time it takes a new salesperson to reach full quota productivity after joining a team — typically three to six months in B2B sales depending on the deal complexity and the rep's prior experience. Ramp plans define the expected attainment trajectory during this period: a new rep might be expected to reach 25% of quota in month two, 50% in month three, and 75% by month five.",
      example: "Riley introduced the new rep to the team: Alex is in month two of their ramp — which means we're expecting approximately 30% of quota attainment this quarter, not 100%. That's not underperformance; it's the plan. My job during ramp is to maximise the quality of the learning, not the quantity of the deals. By the end of month four, I want Alex to be running deals independently with confidence — and that takes time to build correctly.",
      imageSlug: '/images/ramp.png',
    },
    {
      word: 'WIN RATE',
      partOfSpeech: 'phrase',
      definition: 'The percentage of qualified sales opportunities that convert to closed business — a key metric for evaluating pipeline quality, competitive positioning, and process effectiveness. Win rate is typically calculated on qualified opportunities (excluding deals lost at the qualification stage) and tracked by segment, territory, and rep to identify patterns in where deals are being won and lost.',
      example: "Riley reflected on Jordan's win rate trend: Your win rate on enterprise deals above £200,000 has dropped from 38% to 24% over the past two quarters. That's a significant shift — and the question is whether it reflects a change in the competitive landscape, a shift in the quality of opportunities being qualified, a change in your approach at the late stage, or something about how you're handling objections. I don't know which one it is — but you might. What do you think is behind it?",
  ...
  phrasalVerbs: [
    {
      ...
      definition: "The standard opening of a coaching pipeline review — distinguishing between a rep's optimistic narrative about a deal (the pitch) and the objective status of the deal based on observable facts (last activity, agreed next step, stakeholder engagement). This distinction signals to the rep that the manager is looking for honest analysis, not a sales story.",
      example: 'Riley opened the pipeline review with Jordan: Walk me through where the Meridian deal is — not the pitch version, tell me where it actually is. What was the last meaningful interaction? What was agreed as the next step? Who have you spoken to in the last two weeks — and who have you not spoken to that you should have?',
    ...
    },
    {
      ...
      definition: "The coaching question for surfacing whether a rep has a concrete, executable close plan — or whether their forecast is based on hope rather than strategy. A rep who can answer this question specifically (named actions, named stakeholders, specific dates) has a real plan. A rep who answers vaguely ('we're in conversations') does not.",
      example: "Riley asked: You've told me this deal is in negotiate stage and likely to close this quarter. What's your plan to close it before quarter end? Not the general intention — the specific sequence of events: what happens next, who is involved, what decision has to be made by whom, and by what date. Walk me through the close plan step by step.",
    ...
    },
    {
      ...
      definition: 'The reflective coaching question for helping a rep identify what they would change about their approach — without the manager prescribing the answer. It invites self-critique and pattern recognition, which builds transferable learning rather than one-off advice.',
      example: "Riley asked Jordan: The deal has been stuck for 47 days. Looking back — what would you do differently if you could go back to the first call with Meridian? I'm not looking for the 'right' answer, I'm curious what you think. Because whatever comes out of that reflection is probably the most useful thing to take into the next deal you open.",
    ...
    },
    {
      ...
      definition: "The question for driving forecast discipline — asking the rep to name a number they will stand behind with full confidence, rather than offering a range or a best-case figure. The manager's own commitment creates a shared accountability structure: both the rep and the manager are putting their credibility on the line.",
      example: "Riley said: I'm going to commit £280,000 from the team to the forecast for this week's leadership review. That means I need your commit number — not your best case, not the optimistic version. The number that you are certain about, that you would be comfortable having reviewed at the end of the quarter against actuals. What are you committing from your pipeline?",
    ...
    },
    {
      ...
      definition: 'The phrase for communicating strategic direction in a way that requires active translation — not passive listening. Asking each rep to explain their personal version forces them to connect the strategy to their specific territory, accounts, and activities, which reveals both understanding and gaps.',
      example: "Riley briefed the team: The strategy for Q3 is enterprise expansion — deepening relationships in our top 20 accounts rather than chasing net new logos. Every rep on this team should be able to explain their personal version of that strategy in 60 seconds: which three or four of your accounts represent the expansion opportunity, what the specific growth lever is in each, and what you're doing differently this quarter to activate it.",
    ...
    },
    {
      ...
      definition: "The coaching invitation for creating space for the rep to lead the analysis — signalling that the manager's role in this conversation is to listen and respond, not to direct. It positions the rep as the agent of the analysis and the manager as the thinking partner.",
      example: "Riley said to Jordan: Before I share any observations, I want to hear your thinking. Tell me what you see when you look at this deal — what's working, what's not, and what you'd do next if I weren't in the room. I'll ask questions after. The point is not for me to give you the answer — it's for you to work through the analysis out loud so we can both see where the gaps are.",
