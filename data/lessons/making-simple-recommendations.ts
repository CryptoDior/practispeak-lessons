...
export const makingSimpleRecommendations: Lesson = {
  ...
  completeSentenceExercise: {
    ...
    "items": [
        {
            "sentence": "I _____ the Standard Plan for your team — it has everything you need.",
            "options": [
                "match",
                "recommend",
                "suggest"
            ...
            "correctIndex": 1,
            "explanation": "Recommend is the most direct and professional word when you give your clear opinion on the best choice. Suggest is softer — you are offering an idea. Match describes a product fitting someone's needs, not a person giving advice."
        },
        {
            "sentence": "This plan is a good _____ for your needs — it has all the features you asked about.",
            "options": [
                "match",
                "choice",
                "option"
            ...
            "correctIndex": 0,
            "explanation": "Match means the plan fits what the customer needs. Choice is a decision you make. Option is one thing you can choose from. Here, match is the most natural word — it connects the product directly to the customer's specific needs."
        },
        {
            "sentence": "Have you _____ about the Premium Plan? It has more features for a similar price.",
            "options": [
                "think",
                "thought",
                "thinking"
            ...
            "correctIndex": 1,
            "explanation": "The correct phrase is 'Have you thought about'. This is the present perfect tense: have + past participle (thought). Think and thinking are not correct here because the verb have requires the past participle."
        },
        {
            "sentence": "Based on what you _____ me, the Standard Plan is the right choice for you.",
            "options": [
                "say",
                "tell",
                "told"
            ...
            "correctIndex": 2,
            "explanation": "Told is the past tense of tell. We use it to refer to something the customer said earlier in the conversation. The phrase is always 'based on what you told me' — not 'say' (present) or 'tell' (infinitive)."
        },
        {
            "sentence": "The Basic Plan does not have automatic reports — it is not _____ for your needs.",
            "options": [
                "suitable",
                "ideal",
                "option"
            ...
            "correctIndex": 0,
            "explanation": "Suitable means right for the situation. It is an adjective and fits perfectly here. Ideal also works as an adjective, but suitable is the most natural word when something does NOT fit. Option is a noun, not an adjective — you cannot say 'it is not option'."
        },
        {
            "sentence": "That is a great _____! I think you made the right decision.",
            "options": [
                "choose",
                "choosing",
                "choice"
            ...
            "correctIndex": 2,
            "explanation": "Choice is a noun — the word that follows 'a great _____'. Choose is a verb (I choose) and choosing is a verb form (I am choosing). Only a noun can follow 'a great', so choice is the correct answer."
        }
    ]
},
  groupActivities: {
