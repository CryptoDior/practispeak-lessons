...
export const runningEffectiveMeetings: Lesson = {
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: 'Every meeting ends with clear action items — each one has a specific owner and a deadline.',
    ...
    },
    {
      ...
      example: 'The team sends the minutes within 24 hours of every meeting to confirm what was agreed.',
    ...
    },
    {
      ...
      example: 'At the end of each agenda item, the chair summarises what was agreed before moving on.',
    ...
    },
    {
      ...
      example: 'The budget update is a standing item at every monthly review.',
    ...
    },
    {
      ...
      example: 'The Q4 channel allocation is a decision point — the team needs to agree on it before the meeting ends.',
    ...
    },
    {
      ...
      example: 'The website idea was added to the parking lot and will be discussed at a separate meeting next week.',
  ...
  phrasalVerbs: [
    {
      ...
      example: 'The marketing manager took the floor to present the campaign results to the team.',
    ...
    },
    {
      ...
      example: 'The chair brought the late attendee up to speed before the main discussion began.',
    ...
    },
    {
      ...
      example: 'The chair wrapped up the meeting by summarising the three decisions and confirming the action items.',
    ...
    },
    {
      ...
      example: 'The chair reminded the team to stay on track because there was still a key decision to make.',
    ...
    },
    {
      ...
      example: 'The teams agreed to pick up the budget discussion offline rather than use the whole meeting on it.',
    ...
    },
    {
      ...
      example: 'The team agreed to circle back to the influencer strategy after the main priorities were confirmed.',
