  ...
  phrasalVerbs: [
    {
      ...
      visualExamples: [
        { brand: 'GlowLab Skincare', context: 'Beauty / DTC brand — Instagram + TikTok', imageSlug: '/images/visual-examples/glowlab-social-proof.jpg', caption: 'This campaign leverages the principle of social proof — every creative shows a verified customer result, no models.' },
        { brand: 'Noor', context: 'B2B SaaS — LinkedIn sponsored content', imageSlug: '/images/visual-examples/noor-loss-aversion.jpg', caption: 'This campaign leverages the principle of loss aversion — the funnel shows teams what gets dropped when work lives in email.' },
        { brand: 'PeakForm', context: 'Fitness app — paid search + App Store', imageSlug: '/images/visual-examples/peakform-commitment.jpg', caption: 'This campaign leverages the principle of commitment and consistency — users who complete a free 3-day challenge convert at 4x.' },
      ],
    ...
    },
    {
      ...
      visualExamples: [
        { brand: 'Lumiere', context: 'Luxury anti-ageing skincare — department store + DTC site', imageSlug: '/images/visual-examples/lumiere-fear-copy.jpg', caption: 'The customer decision is driven by fear, not aspiration — she is buying protection. Headlines focus on prevention, not glamour.' },
        { brand: 'Vault', context: 'Personal finance app — App Store + Facebook ads', imageSlug: '/images/visual-examples/vault-anxiety-copy.jpg', caption: 'The customer decision is driven by anxiety — she already knows she should save. We reassure, we do not educate.' },
        { brand: 'Archive', context: 'Secondhand fashion marketplace — Instagram + web', imageSlug: '/images/visual-examples/archive-identity-copy.jpg', caption: 'The customer decision is driven by identity — buying vintage is a statement, not a bargain. Price is never the message.' },
      ],
    ...
    },
    {
      ...
      visualExamples: [
        { brand: 'Maison Brulee', context: 'Artisan candle brand — Shopify store + email list', imageSlug: '/images/visual-examples/maison-brulee-scarcity.jpg', caption: '200 units, hand-poured, no restock. We are using scarcity to create urgency — sells out in under an hour every time.' },
        { brand: 'Apex Academy', context: 'Online marketing course — own website + email', imageSlug: '/images/visual-examples/apex-academy-deadline.jpg', caption: 'We are using scarcity to create urgency — founding member pricing closes Sunday, price doubles Monday. Real deadline, real reason.' },
        { brand: 'Meridian Studio', context: 'Brand photography service — Instagram bookings', imageSlug: '/images/visual-examples/meridian-slots.jpg', caption: 'We are using scarcity to create urgency — 2 Q4 slots left, both go by end of week. No fabrication, just truth told loudly.' },
      ],
    ...
    },
    {
      ...
      visualExamples: [
        { brand: 'Ember', context: 'Meal kit subscription — Facebook + Instagram ads', imageSlug: '/images/visual-examples/ember-framing-test.jpg', caption: 'The framing is doing a lot of work — Stop throwing away half your groceries beats Fresh ingredients delivered by 28% CTR.' },
        { brand: 'Shield', context: 'Cybersecurity SaaS — LinkedIn sponsored posts', imageSlug: '/images/visual-examples/shield-fear-frame.jpg', caption: 'The framing is doing a lot of work — What happens when you get breached outperforms Enterprise-grade protection on every metric.' },
        { brand: 'Drift', context: 'Running shoes — Google Shopping + own website', imageSlug: '/images/visual-examples/drift-identity-frame.jpg', caption: 'The framing is doing a lot of work — Built for people who run before work outperforms High-performance running shoe every time.' },
      ],
    ...
    },
    {
      ...
      visualExamples: [
        { brand: 'Noir Maison', context: 'Luxury home fragrance — own e-commerce + Liberty London', imageSlug: '/images/visual-examples/noir-maison-priming.jpg', caption: 'We want to prime the customer before they see the price — first 6 posts are atmosphere only, no products, no prices.' },
        { brand: 'Scope', context: 'B2B analytics platform — email sequences + LinkedIn', imageSlug: '/images/visual-examples/scope-email-priming.jpg', caption: 'We want to prime the customer before the demo request — first 3 emails are only about the problem, Scope is not mentioned until email 4.' },
        { brand: 'Ritual Box', context: 'Wellness subscription — YouTube influencer + own site', imageSlug: '/images/visual-examples/ritual-box-priming.jpg', caption: 'We want to prime the customer before the unboxing ends — the affiliate link goes in after the hero product reveal, not the first 30 seconds.' },
      ],
    ...
    },
    {
      ...
      visualExamples: [
        { brand: 'Bloom', context: 'DTC vitamin brand — Meta ads + email campaigns', imageSlug: '/images/visual-examples/bloom-victim-effect.jpg', caption: 'The psychological insight behind this is the identifiable victim effect — one face converts 3x better than category statistics.' },
        { brand: 'Forge', context: 'Project management SaaS — free trial onboarding funnel', imageSlug: '/images/visual-examples/forge-endowment.jpg', caption: 'The psychological insight behind this is the endowment effect — once users build inside the tool, leaving feels like losing something they made.' },
        { brand: 'Serum No4', context: 'Prestige skincare — Sephora + own DTC site', imageSlug: '/images/visual-examples/serum-no4-exposure.jpg', caption: 'The psychological insight behind this is the mere exposure effect — same creative for 6 weeks on purpose. Familiarity reads as trust.' },
      ],
