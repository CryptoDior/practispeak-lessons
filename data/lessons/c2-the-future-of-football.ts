...
export const c2TheFutureOfFootball: Lesson = {
  ...
  vocabulary: [
    { word: 'ALGORITHM', partOfSpeech: 'noun', definition: 'a set of rules a computer follows to process data and make decisions', example: '"The club\'s scouting algorithm ranks players by performance data, not reputation."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'WELFARE', partOfSpeech: 'noun', definition: 'the health, happiness, and safety of a person', example: '"Player welfare has become a serious concern as fixture schedules grow longer."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'TRANSPARENCY', partOfSpeech: 'noun', definition: 'being open and honest about how decisions are made', example: '"Fans are demanding greater transparency in how club finances are managed."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'SUSTAINABILITY', partOfSpeech: 'noun', definition: 'the ability to continue long term without causing harm', example: '"Financial sustainability is the challenge that most clubs struggle to solve."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'FRAGMENTATION', partOfSpeech: 'noun', definition: 'when something breaks into smaller, separate, disconnected parts', example: '"The fragmentation of broadcast rights has made it harder for fans to watch their club."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'GOVERNANCE', partOfSpeech: 'noun', definition: 'the system of rules and processes for running an organisation', example: '"Poor governance at the top level has allowed corrupt practices to continue unchecked."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'DISPLACE', partOfSpeech: 'verb', definition: 'to push something or someone out of its normal position', example: '"Data analysis has begun to displace gut instinct in scouting decisions."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { word: 'SPECULATION', partOfSpeech: 'noun', definition: 'thinking about what might happen in the future, without certainty', example: '"There is a lot of speculation about how AI will change transfer markets."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'ROLL OUT', definition: 'to introduce something new gradually, stage by stage', example: '"The league plans to roll out real-time player load monitoring across all clubs."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { phrase: 'OPT IN', definition: 'to choose to join or take part in a system or programme', example: '"Players must opt in to share their biometric data with the medical team."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { phrase: 'FLAG UP', definition: 'to identify and draw attention to a problem or concern', example: '"The AI system flagged up three injury risks in the squad before the match."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { phrase: 'PHASE OUT', definition: 'to gradually stop using or doing something over time', example: '"Some analysts believe traditional paper-based scouting will be phased out within ten years."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { phrase: 'LEVEL OUT', definition: 'to become more equal or balanced over time', example: '"If wealth redistribution rules improve, the financial gap between clubs could level out."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
    { phrase: 'SIGN OVER', definition: 'to give control or ownership of something to someone else', example: '"Under the new model, clubs could sign over a percentage of governance rights to supporters."', imageSlug: '/images/c2-the-future-of-football-hero.png' },
  ],
  onThePitch: {
