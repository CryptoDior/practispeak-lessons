...
export const c2CapstoneYourFootballManifesto: Lesson = {
  ...
  vocabulary: [
    { word: 'MANIFESTO', partOfSpeech: 'noun', definition: 'a public statement of your beliefs, values, and intentions', example: '"His football manifesto argued that the sport had lost its soul and needed to find its way back."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'ASSERTION', partOfSpeech: 'noun', definition: 'a confident statement that you claim is true', example: '"The assertion that money has ruined football is hard to argue against when you look at the data."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'ETHOS', partOfSpeech: 'noun', definition: 'the set of values and beliefs that define a person or organisation', example: '"The club\'s founding ethos — community first, profit second — has been abandoned by the new owners."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'IMPERATIVE', partOfSpeech: 'noun', definition: 'something that is absolutely necessary — not optional', example: '"Protecting player welfare is not a preference — it is a moral imperative."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'DENOUNCE', partOfSpeech: 'verb', definition: 'to publicly state that something is wrong or unacceptable', example: '"She denounced the fixture schedule as incompatible with player welfare."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'PROCLAIM', partOfSpeech: 'verb', definition: 'to state something publicly and with confidence', example: '"He proclaimed that beauty in football is not a luxury — it is the point."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'INTEGRITY', partOfSpeech: 'noun', definition: 'the quality of being honest and committed to strong moral principles', example: '"Without integrity at the top of the game, every result becomes questionable."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { word: 'VISION', partOfSpeech: 'noun', definition: 'a clear picture of what you want to achieve or what something should become', example: '"A coaching philosophy is only as strong as the vision behind it."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'STAND FOR', definition: 'to represent or be committed to a set of values', example: '"Every club needs to decide what it stands for — not just on the pitch, but in the community."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { phrase: 'SPEAK OUT', definition: 'to say publicly what you think, especially on a serious issue', example: '"More players need to speak out about the mental health pressures of professional football."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { phrase: 'CALL FOR', definition: 'to demand or argue strongly that something should happen', example: '"The players called for an independent review of the fixture list."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { phrase: 'HOLD TO', definition: 'to stay committed to a belief or principle under pressure', example: '"The best coaches hold to their philosophy even when the results are difficult."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { phrase: 'PUSH BACK', definition: 'to resist or challenge an idea or decision', example: '"Fans need to push back when clubs make decisions that contradict the club\'s ethos."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
    { phrase: 'LIVE UP TO', definition: 'to reach the standard or promise you have claimed or committed to', example: '"The league has proclaimed its commitment to integrity — now it must live up to it."', imageSlug: '/images/c2-capstone-your-football-manifesto-hero.png' },
  ],
  onThePitch: {
