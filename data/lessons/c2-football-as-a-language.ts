...
export const c2FootballAsALanguage: Lesson = {
  ...
  vocabulary: [
    { word: 'SPATIAL', partOfSpeech: 'adjective', definition: 'relating to space and the positions of things', example: '"His spatial awareness lets him find pockets of space that others miss."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'COMPRESS', partOfSpeech: 'verb', definition: 'to push or squeeze something into a smaller space', example: '"They compress into a low block to make it very hard to score."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'CHANNEL', partOfSpeech: 'noun', definition: 'a corridor of space, usually between a centre-back and a full-back', example: '"The striker ran into the channel and dragged the defender wide."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'TRIGGER', partOfSpeech: 'noun / verb', definition: 'a signal or event that starts a planned action', example: '"A back pass is the trigger for the whole team to press high."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'ARTICULATE', partOfSpeech: 'verb', definition: 'to express something clearly — for a team, to carry out a plan with precision', example: '"The best teams articulate their press without needing to speak."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'CHOREOGRAPHY', partOfSpeech: 'noun', definition: 'a carefully planned sequence of movements', example: '"The combination play looked like choreography — every run was timed perfectly."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'DECODE', partOfSpeech: 'verb', definition: 'to work out the pattern or meaning of something complex', example: '"Good defenders decode the opponent\'s movement before the ball is played."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { word: 'POCKET', partOfSpeech: 'noun', definition: 'a small area of space between defenders that a player moves into', example: '"He drifted into the pocket between the lines and had time on the ball."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'OPEN UP', definition: 'to create space by moving or spreading wide', example: '"The full-backs pushed forward to open up the play."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { phrase: 'DROP OFF', definition: 'to move backward to receive the ball', example: '"The striker dropped off to link the play and create a passing angle."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { phrase: 'GET IN BEHIND', definition: 'to run past the defensive line into open space', example: '"He timed his run perfectly to get in behind before the pass came."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { phrase: 'SWITCH OFF', definition: 'to lose focus and stop tracking the play', example: '"The goal happened because one midfielder switched off for two seconds."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { phrase: 'PRESS UP', definition: 'to move the defensive line forward as a unit', example: '"When they press up, the offside trap becomes a real weapon."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
    { phrase: 'READ INTO', definition: 'to find patterns or meaning in something you observe', example: '"You can read into their shape whether they plan to attack wide or through the middle."', imageSlug: '/images/c2-football-as-a-language-hero.png' },
  ],
  onThePitch: {
