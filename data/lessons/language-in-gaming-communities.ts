...
export const languageInGamingCommunities: Lesson = {
  slug: 'language-in-gaming-communities',
  title: 'Language in Gaming Communities',
  subtitle:
    'How a server full of strangers turns into "us" — through slang, shorthand, in-jokes, and the small words that quietly sort who belongs',
  level: 'C1-C2',
  description:
