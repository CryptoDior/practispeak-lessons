...
export const esportsAsAProfession: Lesson = {
  slug: 'esports-as-a-profession',
  title: 'Esports as a Profession',
  subtitle:
    'What it actually takes to go pro — contracts, sponsorships, burnout, and the short, strange shelf life of a competitive career',
  level: 'C1-C2',
  description:
