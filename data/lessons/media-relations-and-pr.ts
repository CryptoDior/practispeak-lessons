  ...
  vocabulary: [
    {
      ...
      example: "Riley reviewed the draft: This press release is too long and too promotional. Marcus asked: What is wrong with being promotional? Riley replied: A press release is not an advert — it is information for a journalist. Journalists are looking for a story, not a sales pitch. If the first paragraph reads like marketing copy, the journalist moves on. The first paragraph needs to answer four questions: what happened, why it matters, who is involved, and when. Everything else is supporting detail. Dana added: And the quote from the CEO needs to sound like something a real person said, not a corporate statement. Journalists use quotes because they add a human voice to the story. If the quote sounds like it was written by a committee, they will not use it — and the best part of your announcement disappears from the coverage.",
    ...
    },
    {
      ...
      example: "Marcus explained the launch plan: We are going to embargo the announcement until Friday at 6am. That means we brief selected journalists on Wednesday, give them the full story, access to the CEO for an interview, and the product for review — but they agree not to publish until Friday. Riley asked: What if a journalist breaks the embargo? Marcus replied: It has happened before and it is serious. If they publish early, we have to decide immediately whether to accelerate the announcement for everyone else, issue a statement that coverage appeared ahead of schedule, and make a decision about whether we work with that journalist again. Dana added: Embargoes only work because they are built on trust. You give the journalist early access and a better story in exchange for their cooperation on timing. Most journalists honour them because breaking one damages their own reputation with PR teams across the industry.",
    ...
    },
    {
      ...
      example: "Dana prepared the launch media kit: We have six components. The press release. A fact sheet with product specifications and pricing. High-resolution product images in three formats. The CEO biography and headshot. A company background document. And three customer case studies the journalist can use as real-world examples. Riley asked: Who gets the full kit and who gets a summary? Dana replied: Tier one media — our priority outlets — get the full kit, early access, and an interview slot. Tier two get the kit without the interview. Tier three get the press release only. Marcus added: The quality of the media kit directly affects the quality of the coverage. If journalists have to chase for a photo or cannot find the correct product name, the story gets delayed or gets the details wrong.",
    ...
    },
    {
      ...
      example: "Riley led the spokesperson preparation session: We have three people authorised to speak to media for this launch — the CEO for strategic and brand questions, the CTO for product and technology questions, and the marketing director for campaign questions. Marcus asked: What if a journalist asks the CEO a technology question? Riley replied: The CEO redirects. She says: 'I am going to bring in our CTO for that — she is the best person to answer on the technical detail.' Redirection is not evasion — it is accuracy. Dana added: Every spokesperson needs to know three things before any media interaction: the two or three key messages they need to land, the questions they are most likely to be asked, and the one or two questions they should not answer — and exactly what to say instead of answering them.",
    ...
    },
    {
      ...
      example: "Dana briefed the CEO before the interview: There is one topic where you need to be very careful — the acquisition rumours. Marcus asked: Can she go off the record on that? Dana replied: Only if the journalist agrees, and only if she establishes that before she says anything. She needs to say: 'Before I say anything on this, can we agree this is off the record?' — and wait for confirmation. Riley added: Off the record is not a magic phrase that protects everything you say. If a CEO says something revealing and then says 'by the way, that was off the record,' the journalist is not bound by that — the agreement has to come first. Dana: And even off the record, be careful. A journalist who agrees cannot directly report what you said, but they can use it as background to ask better questions or to find another source who will go on the record with the same information.",
    ...
    },
    {
      ...
      example: "Marcus organised the pre-launch media briefings: We have twelve briefings scheduled across three days — eight print and online journalists, three broadcast teams, and one industry analyst. Riley asked: What is the format? Marcus replied: 30 minutes each. Ten minutes from the CEO on the strategic vision. Ten minutes on the product from the CTO. Ten minutes of Q&A. Dana added: The briefing is also our chance to shape the story before it is written. If a journalist's first interaction with this announcement is the press release, the story they write will be shaped by that alone. If their first interaction is a conversation with our CEO, the story will reflect that relationship, that access, and that level of detail. Briefings convert press release coverage into considered, in-depth journalism.",
    ...
    },
    {
      ...
      example: "Riley reviewed the pitch: The press release is well-written but there is no news hook. Marcus asked: What do you mean? Riley replied: Why should a journalist write about this product today? What makes it newsworthy right now? If the answer is 'it is a good product,' that is not a news hook — that is a feature. A news hook is something time-specific: a new research finding, a regulatory change, a seasonal moment, a competitor announcement, or a cultural event that makes your story relevant right now. Dana added: The news hook is often the difference between coverage and silence. A journalist receives hundreds of press releases a week. The ones that make it to print are the ones that answer the question: why does this matter, today, to my readers? The press release needs to answer that in the first sentence.",
    ...
    },
    {
      ...
      example: "Dana presented the PR results: Our launch generated 47 pieces of earned media — 23 online articles, 14 print features, 6 broadcast mentions, and 4 podcast appearances. Marcus asked: What is the equivalent advertising value? Dana replied: Our agency calculates earned media value using the advertising equivalent — the cost of buying that amount of space or airtime. The total is approximately £380,000. Riley added: But earned media has a different kind of value beyond the advertising equivalent. A journalist writing independently about your product carries more credibility with readers than an ad. The reader knows you paid for the ad. They do not know what motivated the journalist — but they assume it was the quality of the story. That third-party endorsement is difficult to buy and very valuable when you earn it.",
  ...
  phrasalVerbs: [
    {
      ...
      example: "Riley coached the CEO before the journalist call: There will be a question about the acquisition rumours — I am almost certain of it. Dana asked: What should she say? Riley replied: She can share context, but she needs to establish the terms first. She should say: 'I can give you some background on that — but this is strictly off the record, I am sharing this as background context only. Are we agreed on that?' Wait for the journalist to confirm, then share only what she is comfortable with potentially becoming public anyway. Marcus added: The golden rule is this: never say anything off the record that you would be genuinely damaged by if it appeared in print. Off the record reduces the likelihood of publication — it does not eliminate it. If the journalist believes the public interest is significant enough, they may still find a way to report the substance of what you told them.",
    ...
    },
    {
      ...
      example: "Dana briefed the journalists on the embargo terms: We have an embargo until Friday the 14th at 6am GMT. That means you have until Thursday to ask follow-up questions, request additional images, or arrange any additional interviews you need. Riley added: Please confirm by email that you accept the embargo terms — we need that confirmation before we share the product access. Marcus explained the rationale: We are giving you early access and more detail than you would get from the press release alone. In exchange, we ask for your cooperation on timing — so that we can coordinate our internal communications, our social media, and our customer notification simultaneously. Dana: If the embargo is broken, we reserve the right to accelerate the announcement for all other media — which means the exclusivity of your early access is lost.",
    ...
    },
    {
      ...
      example: "Riley reviewed the draft press release: The story needs a stronger news hook — right now it reads as a product announcement with no reason to exist today rather than any other day. Marcus asked: What would make a stronger hook? Riley replied: Three options. One — tie it to a trend or a data point: 'New research shows 73% of marketers struggle with X — our new product solves exactly that problem.' Two — tie it to a news event: 'As new regulations take effect this month, businesses face X challenge. Our solution...' Three — the exclusivity angle: offer one journalist the story first, with more detail and an interview, in exchange for a front-page placement. Dana added: The hook is the first sentence a journalist reads. If it does not immediately answer 'so what?' the press release goes in the bin. The product can be genuinely excellent and still generate zero coverage if the pitch does not give the journalist a reason to care today.",
    ...
    },
    {
      ...
      example: "Marcus outlined the media strategy: We are pitching this as an exclusive to one of the major national business outlets. Riley asked: Which one and why? Marcus replied: The journalist who covers our sector most thoroughly and has the largest readership among our target audience. We are offering her the story 48 hours before the wider announcement, with a one-on-one interview with the CEO and access to the product before launch. In exchange, we want front-page placement in the business section on launch day. Dana added: The exclusive strategy is a trade. You give one journalist something no one else has. In exchange, you get better, more prominent coverage than you would get from a standard press release to the full list. The risk is that if the exclusive journalist decides not to run the story, you have lost two days and you have nothing. So you choose your exclusive outlet carefully and have a contingency plan ready.",
    ...
    },
    {
      ...
      example: "Dana walked into the crisis call: We have a problem. A journalist at a national outlet has contacted us asking for comment on an internal complaint that was filed six months ago. They say they are publishing tomorrow with or without a response. Marcus asked: What are our options? Dana replied: We have two. One — we respond with a brief, factual statement and offer a call with our HR director to give context. Two — we say nothing and let the story run without our side. Riley said: Option one. We need to get ahead of this story before it runs without any of our context. If we do not respond, the journalist writes the story entirely from the complainant's perspective. If we respond — even briefly — the story has to include our position. Dana: And we should consider whether there is anything we can proactively disclose that shows we took the complaint seriously and acted on it — because that changes the story from 'company ignores complaint' to 'company investigated and addressed complaint.'",
    ...
    },
    {
      ...
      example: "Riley sent the pre-launch status to the team: The spokesperson is being briefed on three areas — the product story, the competitive positioning, and the one topic we are not discussing publicly yet. Marcus asked: How long does the briefing take? Riley replied: Two sessions. Tomorrow — a 90-minute session covering the key messages, the product narrative, and the questions we expect. Day of interview — a 30-minute refresher to go through the most likely opening questions and any news that has broken since the first briefing. Dana added: The most important part of the briefing is the questions we cannot answer. Every spokesperson needs to know in advance what they will say when a question lands that they cannot respond to directly. 'I am not in a position to comment on that at this stage, but what I can tell you is...' — that phrase needs to be rehearsed, not improvised under pressure.",
