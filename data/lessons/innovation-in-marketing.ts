  ...
  vocabulary: [
    {
      ...
      partOfSpeech: 'noun',
      definition: "Technology that adds digital elements — images, information, or interactive features — to a real-world view, usually through a smartphone camera or special glasses. In marketing, AR allows consumers to visualise products in their own environment before buying, creating a more immersive and confident purchase experience. Abbreviated as AR.",
      example: "Riley presented the AR case: IKEA's augmented reality app lets customers place furniture in their own room using their phone camera before buying. The result is a 35% reduction in product returns and significantly higher purchase confidence. Marcus replied: Which directly addresses one of the biggest barriers to furniture purchase online — the fear that it will not fit or look right in the actual space. Dana added: And it creates a memorable brand interaction. The customer is not just browsing a catalogue — they are actively experiencing the product in their own context. That level of engagement is difficult to achieve with any traditional marketing format.",
      imageSlug: '/images/augmented-reality.png',
    },
    {
      word: 'CHATBOT',
      partOfSpeech: 'noun',
      definition: "A computer programme that has conversations with users — answering questions, guiding them through a process, or collecting information — usually via a messaging interface on a website or app. Modern AI-powered chatbots can handle complex, natural-sounding conversations. They are used in marketing for lead qualification, customer support, and content recommendation.",
      example: "Dana explained: We have deployed a chatbot on the product pages that asks visitors three qualifying questions — what they are trying to achieve, what their current solution is, and what their timeline is. Based on the answers, it either books a call with a sales team member or recommends a self-serve resource. Marcus asked: What is the conversion impact? Dana replied: Visitors who interact with the chatbot convert to trial at 34% — versus 8% for visitors who do not. Riley added: The chatbot is not replacing the sales team — it is qualifying the opportunity before the sales team gets involved, so they are spending time only on genuinely interested leads.",
    ...
    },
    {
      word: 'AUTOMATION',
      partOfSpeech: 'noun',
      definition: "Using technology to complete repetitive marketing tasks — such as sending emails, posting on social media, or scoring leads — without manual effort for each individual action. Marketing automation frees teams to focus on creative and strategic work while technology handles execution at scale.",
      example: "Marcus presented: We have built a full automation workflow for post-purchase emails. When a customer completes a purchase, the system automatically sends a confirmation, then a delivery update, then a day-7 satisfaction check, then a day-30 review request. Riley asked: What was the manual process before? Marcus replied: A team of three people manually sending emails based on spreadsheets. Dana added: And the automated emails are performing better than the manual ones — open rate is up 18% and review completion is up 34% — because the timing is precise, the personalisation is accurate, and no email is ever forgotten because someone was busy.",
      imageSlug: '/images/automation.png',
    },
    {
      word: 'AI IN MARKETING',
      partOfSpeech: 'noun',
      definition: "The use of artificial intelligence technologies — machine learning, large language models, image recognition, predictive analytics — to improve marketing decisions, automate content creation, personalise experiences, and optimise campaigns in real time. AI in marketing is the umbrella term for a wide range of specific tools and applications.",
      example: "Dana explained: We are using AI in marketing in four specific ways. One — content generation: first drafts of ad copy, email subject lines, and social posts. Two — audience segmentation: AI identifies behavioural patterns that human analysts would miss. Three — campaign optimisation: the system adjusts bids and creative in real time based on performance data. Four — predictive churn: AI identifies customers most likely to cancel 30 days before they do, so we can intervene proactively. Marcus replied: Which of the four has had the biggest commercial impact? Dana: Predictive churn — by a significant margin.",
  ...
  phrasalVerbs: [
    {
      ...
      definition: "A phrase for describing a specific, concrete application of artificial intelligence in marketing. Always complete with the specific task or outcome — not with a general statement about AI. Used in pitches, strategy presentations, and technology discussions to make the AI application tangible.",
      example: "Dana presented: We are using AI to do three things that were either impossible or prohibitively expensive before. First — personalise the homepage for each visitor in real time based on their browsing history. Second — generate first drafts of ad copy in 12 language variants simultaneously. Third — identify the 10% of customers most likely to churn in the next 30 days so we can intervene proactively. Marcus said: Those are three very different applications. Riley commented: Which is the point — AI in marketing is not one thing. It is a family of tools, each with a specific use case and a specific business case.",
    ...
    },
    {
      ...
      definition: "A phrase for explaining the specific purpose and function of a chatbot — what it is intended to do in the customer or prospect journey. Always specify the use case: lead qualification, customer support, onboarding, or content recommendation.",
      example: "Riley explained: The chatbot is designed to qualify inbound leads before they reach the sales team. It asks three questions — what the visitor is trying to achieve, what their current solution is, and what their budget and timeline are. Based on the answers, it routes high-quality leads directly to a sales calendar booking and sends lower-quality leads to a self-serve resource library. Marcus asked: What is the routing logic? Riley replied: Any lead that meets two of three criteria — right budget, right timeline, right use case — goes to sales. The chatbot is not replacing the sales conversation — it is ensuring the sales team is only having conversations with people who are genuinely ready to have them.",
    ...
    },
    {
      ...
      definition: "A phrase for describing what becomes possible when personalisation is delivered through technology rather than manual effort — showing the commercial or strategic outcome rather than just describing the capability. Used in presentations, pitches, and strategy discussions to make the business case for personalisation investment.",
      example: "Riley explained: Personalisation at scale allows us to deliver an experience that feels one-to-one to each customer, even though we have 400,000 of them. Marcus asked: What does that mean commercially? Riley replied: Our personalised email campaign has an open rate of 42% versus 18% for our generic broadcast emails. Click-through is 5.1% versus 1.3%. And conversion from those clicks is 2.8 times higher. Dana added: The reason personalisation at scale is only possible with technology is that doing it manually for 400,000 people would require a team of thousands. The technology creates an experience that feels human without requiring human effort at every touchpoint.",
    ...
    },
    {
      ...
      definition: "A phrase for describing the specific tasks or processes that a marketing automation system manages — replacing manual effort. Always specify what the automation does and what the result is. Used to explain the scope and value of automation to stakeholders who may not be familiar with the technology.",
      example: "Dana explained: The automation handles every stage of the post-purchase journey — from order confirmation through to review request — with no manual intervention required. The system knows the customer's purchase date, their product category, and their previous review history, and it uses that data to personalise the timing and content of each message. Marcus asked: What if a customer has a problem with the order? Dana replied: The automation is connected to the customer support system. If a customer opens a support ticket, the automated sequence pauses immediately so they do not receive a 'we hope you love your order' email while they are dealing with a problem.",
    ...
    },
    {
      ...
      definition: "A phrase for explaining what the test and learn methodology requires or enables in practice — what changes about how decisions are made, how risk is managed, and how innovation is deployed. Used to introduce or defend an experimental approach to marketing technology.",
      example: "Marcus explained: The test and learn approach means we never deploy a new technology across all channels simultaneously. We always start with a controlled experiment — one channel, one audience segment, one defined success metric — and measure the result against a control group before we scale. Riley asked: What if the test is inconclusive? Marcus replied: An inconclusive test is still valuable — it tells us we have not yet found the right format or audience for this tool, and gives us a hypothesis to test next. Dana added: The test and learn approach also protects us from the opposite mistake — assuming a new technology does not work because we deployed it badly the first time. Small, structured tests separate the technology's potential from the quality of our implementation.",
    ...
    },
    {
      ...
      definition: "A phrase for describing the specific consumer experience enabled by AR technology — what the customer can now do that they could not do before. Always describe the customer action and the benefit to them. Used in innovation pitches, product marketing briefings, and technology investment proposals.",
      example: "Riley described the AR capability: Augmented reality lets customers place our product in their own home using their phone camera before they buy. They can change the colour, the size, and the position — and they can share a screenshot with a partner or family member for a second opinion. Marcus asked: What is the impact on purchase decisions? Riley replied: Customers who use the AR feature convert at 2.6 times the rate of those who do not, and their return rate is 40% lower. Dana added: The lower return rate is the often-missed part of the business case. AR does not just improve conversion — it improves the quality of the decision, which means fewer returns, fewer unhappy customers, and lower customer service cost.",
