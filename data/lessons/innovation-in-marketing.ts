  ...
  vocabulary: [
    {
      ...
      partOfSpeech: 'noun',
      definition: "Technology that adds digital images or information to the real world through your phone camera. Used in marketing to let customers see products in their own space before buying. Abbreviated as AR.",
      example: "The app uses augmented reality so customers can see how furniture looks in their room before they order.",
      imageSlug: '/images/augmented-reality.png',
    },
    {
      word: 'CHATBOT',
      partOfSpeech: 'noun',
      definition: "A computer programme that has automated conversations with customers on a website or app. Used in marketing to answer questions, qualify leads, and guide customers without manual effort.",
      example: "We added a chatbot to our website to answer the most common customer questions automatically.",
      imageSlug: '/images/chatbot.png',
    },
    {
      word: 'PERSONALISATION',
      partOfSpeech: 'noun',
      definition: "Showing different content, products, or messages to different people based on their behaviour or purchase history. It makes customers feel understood.",
      example: "The website uses personalisation to show each customer the products they are most likely to buy.",
      imageSlug: '/images/innovation-in-marketing-personalisation.png',
    },
    {
      word: 'AUTOMATION',
      partOfSpeech: 'noun',
      definition: "Using technology to complete repetitive tasks — like sending emails or following up with leads — without manual effort each time.",
      example: "We use automation to send follow-up emails after every purchase, without anyone doing it manually.",
      imageSlug: '/images/automation.png',
    },
    {
      word: 'AI IN MARKETING',
      partOfSpeech: 'noun',
      definition: "Using artificial intelligence to improve marketing — for example, writing content, finding the right audience, and predicting what customers will do next.",
      example: "The team uses AI in marketing to find which customers are most likely to buy again and target them first.",
      imageSlug: '/images/ai-in-marketing.png',
    },
    {
      word: 'PREDICTIVE',
      partOfSpeech: 'adjective',
      definition: "Using past data to forecast what a customer will do next — like whether they will buy again or cancel.",
      example: "The company uses a predictive tool to identify customers who might cancel before they actually do.",
      imageSlug: '/images/innovation-in-marketing-predictive.png',
    },
    {
      word: 'DYNAMIC CONTENT',
      partOfSpeech: 'noun',
      definition: "Content that changes automatically based on who is viewing it — for example, showing different products to different people in the same email.",
      example: "The newsletter uses dynamic content to show a different product to each customer based on what they bought before.",
      imageSlug: '/images/innovation-in-marketing-dynamic-content.png',
    },
    {
      word: 'TEST AND LEARN',
      partOfSpeech: 'noun / verb',
      definition: "An approach where you try something small, measure the result, and improve — rather than trying to get everything right before you start.",
      example: "We use a test and learn approach when trying new tools — we start with one channel and measure the results before expanding.",
  ...
  phrasalVerbs: [
    {
      ...
      definition: "A phrase for saying how your company uses AI for a specific task. Always complete it with the exact task or result.",
      example: "We are using AI to identify customers who are likely to cancel before they do.",
    ...
    },
    {
      ...
      definition: "A phrase for explaining what a chatbot does and why. Always say the specific purpose — like answering questions, finding good leads, or helping customers choose a product.",
      example: "The chatbot is designed to qualify new leads before they speak to the sales team.",
    ...
    },
    {
      ...
      definition: "A phrase for describing what becomes possible when technology personalises for a very large number of customers. Always say the specific result.",
      example: "Personalisation at scale allows us to send a different message to each customer based on what they bought before.",
    ...
    },
    {
      ...
      definition: "A phrase for describing the specific tasks that a marketing automation system manages. Always say what the automation does and what this means for the team.",
      example: "The automation handles all post-purchase emails, so the team does not have to send them manually.",
    ...
    },
    {
      ...
      definition: "A phrase for explaining what the test and learn method requires or makes possible in your team.",
      example: "The test and learn approach means we try new tools on one channel first before rolling them out everywhere.",
    ...
    },
    {
      ...
      definition: "A phrase for describing what customers can do with AR technology. Always say the specific action and the benefit.",
      example: "Augmented reality lets customers see how a product looks in their own home before they buy it.",
