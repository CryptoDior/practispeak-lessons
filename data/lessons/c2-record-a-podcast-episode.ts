...
export const c2RecordAPodcastEpisode: Lesson = {
  ...
  vocabulary: [
    { word: 'HOOK', partOfSpeech: 'noun', definition: 'an opening line or idea that grabs the listener\'s attention immediately', example: '"A strong hook in the first ten seconds is what keeps people listening instead of skipping."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'SEGMENT', partOfSpeech: 'noun', definition: 'one section or part of a podcast or broadcast', example: '"The episode is divided into three segments — the main story, an interview clip, and the analysis."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'TRANSCRIPT', partOfSpeech: 'noun', definition: 'a written version of everything said in a recording', example: '"Always read the transcript of your episode after recording — you will hear things you missed."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'SCRIPTED', partOfSpeech: 'adjective', definition: 'planned and written down before being spoken', example: '"The opening is fully scripted, but the discussion section is unscripted and spontaneous."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'PACING', partOfSpeech: 'noun', definition: 'the speed and rhythm of your speech', example: '"Good pacing means slowing down for the key points and speeding up during stories."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'CRITIQUE', partOfSpeech: 'noun / verb', definition: 'a detailed judgment of strengths and weaknesses — or to do that', example: '"After each recording, critique your own delivery: pacing, clarity, and register."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'CODA', partOfSpeech: 'noun', definition: 'a final section that closes the piece with a strong, memorable ending', example: '"The best podcast codas leave the listener with one clear thought to take away."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { word: 'REGISTER', partOfSpeech: 'noun', definition: 'the level of formality in language — formal, neutral, or informal', example: '"The register of a podcast is usually conversational — not too formal, not too casual."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
  ],
  phrasalVerbs: [
    { phrase: 'WRAP UP', definition: 'to bring something to a close', example: '"Let us wrap up this segment and move to the main interview."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { phrase: 'PICK UP ON', definition: 'to notice and develop a specific detail or idea', example: '"I want to pick up on something you said earlier — about the role of data in modern scouting."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { phrase: 'FILL IN', definition: 'to give background information the listener needs', example: '"Before we get to the match, let me fill in some context about the rivalry."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { phrase: 'CUT TO', definition: 'to move quickly from one topic or idea to the next', example: '"Let us cut to the key question: was the referee right or wrong?"', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { phrase: 'SIGN OFF', definition: 'to say goodbye and close a broadcast or recording', example: '"Thanks for listening — and we will sign off with one final thought."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
    { phrase: 'ZOOM IN ON', definition: 'to focus closely on one specific detail or idea', example: '"I want to zoom in on that second-half substitution — it changed everything."', imageSlug: '/images/c2-record-a-podcast-episode-hero.png' },
  ],
  onThePitch: {
