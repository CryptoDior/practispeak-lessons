  ...
  vocabulary: [
    {
      word: 'AVATAR',
      partOfSpeech: 'noun',
      definition: 'The character you create and play as inside Roblox.',
    ...
    },
    {
      word: 'CHARACTER',
      partOfSpeech: 'noun',
      definition: 'The figure on screen that you move and control in the game.',
    ...
    },
    {
      word: 'USERNAME',
      partOfSpeech: 'noun',
      definition: 'The unique name you use to log in to Roblox and be found by friends.',
    ...
    },
    {
      word: 'DISPLAY NAME',
      partOfSpeech: 'noun',
      definition: "The name that appears above your avatar's head for other players to see.",
    ...
    },
    {
      word: 'PROFILE',
      partOfSpeech: 'noun',
      definition: 'Your personal Roblox page showing your avatar, badges, and favourite games.',
    ...
    },
    {
      word: 'OUTFIT',
      partOfSpeech: 'noun',
      definition: 'The saved combination of clothes and items your avatar is wearing.',
    ...
    },
    {
      word: 'CUSTOMIZE',
      partOfSpeech: 'verb',
      definition: "To change your avatar's hair, clothes, and accessories to make it yours.",
  ...
  irlVocabulary: [
    {
      word: 'AVATAR',
      partOfSpeech: 'noun',
      definition: 'A digital picture or cartoon that represents you on any app or website.',
    ...
    },
    {
      word: 'CHARACTER',
      partOfSpeech: 'noun',
      definition: 'A person in a book, film, or TV show — like a hero or villain in a story.',
    ...
    },
    {
      word: 'USERNAME',
      partOfSpeech: 'noun',
      definition: 'The name you choose when you sign up for any website, app, or platform.',
    ...
    },
    {
      word: 'DISPLAY NAME',
      partOfSpeech: 'noun',
      definition: 'The name your contacts see on apps like WhatsApp, Snapchat, or Instagram.',
    ...
    },
    {
      word: 'PROFILE',
      partOfSpeech: 'noun',
      definition: 'Your personal page on a social media app or website showing your name and photo.',
    ...
    },
    {
      word: 'OUTFIT',
      partOfSpeech: 'noun',
      definition: 'The complete set of clothes you choose to wear on a particular day.',
    ...
    },
    {
      word: 'CUSTOMIZE',
      partOfSpeech: 'verb',
      definition: 'To change something to make it personal — your room, phone, bag, or style.',
    ...
    },
    {
      word: 'ACCESSORY',
      partOfSpeech: 'noun',
      definition: 'An extra item you wear to complete your look, like a watch, bag, or necklace.',
      example: 'A watch is a popular accessory — it is useful and looks stylish.',
      imageSlug: '/images/roblox-avatar-identity-accessory.png',
    },
  ],
