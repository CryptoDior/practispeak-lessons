  ...
  vocabulary: [
    {
      ...
      example: 'Kick the ball toward the cones — the coach is watching your technique.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick.png',
    },
    {
      word: 'PASS',
      partOfSpeech: 'verb',
      definition: 'To send the ball to a teammate using your foot.',
      example: 'She passed the ball quickly before the defender could reach her.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/pass.png',
    },
    {
      word: 'SHOOT',
      partOfSpeech: 'verb',
      definition: 'To kick the ball toward the goal to try to score.',
      example: 'He shot at goal under the floodlights and the goalkeeper could not reach it.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-shoot.png',
    },
    {
      word: 'TACKLE',
      partOfSpeech: 'verb',
      definition: 'To take the ball from an opponent using your feet.',
      example: 'She made a clean tackle and won the ball back for her team.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-tackle.png',
    },
    {
      word: 'DRIBBLE',
      partOfSpeech: 'verb',
      definition: 'To run with the ball, using small kicks to control it.',
      example: 'He dribbled through the cones in training, keeping the ball close to his foot.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-dribble.png',
    },
    {
      word: 'CROSS',
      partOfSpeech: 'verb',
      definition: 'To kick the ball from the side into the middle of the pitch.',
      example: 'She crossed the ball from the corner into the box for her teammate to shoot.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-cross.png',
    },
    {
      word: 'HEADER',
      partOfSpeech: 'noun',
      definition: 'When you hit the ball with your head.',
      example: 'He jumped above the defender and scored with a powerful header.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-header.png',
    },
    {
      word: 'VOLLEY',
      partOfSpeech: 'noun / verb',
      definition: 'To kick the ball before it touches the ground. / A kick like this.',
      example: 'She hit a volley in front of a packed stadium and it flew past the goalkeeper.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-volley.png',
    },
  ],
  ...
  phrasalVerbs: [
    {
      ...
      example: 'She kicked the ball with her right foot during the training session.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/with-your-right-foot.png',
    },
    {
      phrase: 'WITH YOUR LEFT FOOT',
      definition: 'Using the left foot to kick or pass.',
      example: 'He shot with his left foot in the rain and the ball went into the bottom corner.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/with-your-left-foot.png',
    },
    {
      phrase: 'WITH YOUR HEAD',
      definition: 'Using the head to direct the ball.',
      example: 'She jumped high above the defender and scored with her head.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/with-your-head.png',
    },
    {
      phrase: 'FIRST TOUCH',
      definition: 'The first time you touch the ball when you receive it.',
      example: 'His first touch was clean and he moved the ball away from the defender quickly.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-first-touch.png',
    },
    {
      phrase: 'ON TARGET',
      definition: 'A shot that goes toward the goal (between the posts).',
      example: 'He shot on target from close range and the goalkeeper could not stop it.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/kick-pass-shoot-on-target.png',
    },
    {
      phrase: 'INTO SPACE',
      definition: 'Kicking or passing to an empty area on the pitch.',
      example: 'She passed the ball into space and her teammate ran onto it at full speed.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/into-space.png',
    },
  ],
