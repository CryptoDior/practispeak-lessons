...
export const customerRetentionAndLoyalty: Lesson = {
  ...
  vocabulary: [
    ...
    },
    {
      ...
      definition: "Net Promoter Score — a measure of customer loyalty. Customers are asked: on a scale of 0 to 10, how likely are you to recommend this company to a friend or colleague? Scores of 9-10 are Promoters, 7-8 are Passives, 0-6 are Detractors. NPS is calculated by subtracting the percentage of Detractors from the percentage of Promoters.",
      example: "Dana presented the quarterly NPS results: Our NPS is 34 — which puts us in the average range for our sector. Marcus asked: What is dragging it down? Dana replied: The Detractors are concentrated in customers who have been with us for 6 to 18 months. Riley added: That is the danger zone — the initial excitement has worn off but they have not yet experienced the long-term value. We need to do more in that window to deepen engagement.",
      imageSlug: '/images/nps.png',
    },
    {
      word: 'LOYALTY PROGRAMME',
      partOfSpeech: 'noun',
      definition: "A structured system that rewards customers for repeat purchases or continued engagement — through points, discounts, exclusive access, or status tiers. A good loyalty programme makes customers feel recognised and gives them a reason to choose you over a competitor, even when the competitor is slightly cheaper.",
      example: "Riley proposed: We should launch a loyalty programme for customers who have been with us for more than 12 months. Dana asked: What would the rewards be? Riley suggested: Three tiers — Silver, Gold, and Platinum — based on annual spend. Silver gets early access to new features. Gold gets a dedicated account manager. Platinum gets co-creation invitations and a named case study. Marcus added: The programme needs to feel like recognition, not a points system. Recognition is what builds emotional loyalty.",
      imageSlug: '/images/loyalty-programme.png',
    },
    {
      word: 'LIFETIME VALUE',
      partOfSpeech: 'noun',
      definition: "The total revenue a business can expect to earn from a single customer over the entire duration of their relationship. Lifetime value — or LTV — is one of the most important metrics in marketing because it tells you how much you can afford to spend to acquire and retain a customer.",
      example: "Marcus explained the business case for retention: Our average customer lifetime value is £4,200. Our cost of acquisition is £350. That means if we can extend the average customer relationship from 18 months to 24 months, the LTV goes up by roughly £1,400 per customer. Dana replied: And if we have 3,000 active customers, that is £4.2 million in additional revenue — from better retention alone, with no increase in acquisition spend.",
      imageSlug: '/images/lifetime-value.png',
    },
    {
      word: 'RE-ENGAGEMENT',
      partOfSpeech: 'noun',
      definition: "The process of reconnecting with customers who have become inactive or disengaged — customers who have not purchased recently, have stopped opening emails, or have reduced their usage. Re-engagement campaigns aim to bring these customers back before they churn completely.",
      example: "Dana proposed: We have 800 customers who have not opened a single email in three months and whose platform usage has dropped by 70%. These are high churn risk. We need a re-engagement campaign — a specific sequence of messages designed to reconnect them before they cancel. Riley suggested: The first message should not be a discount — it should be a genuine value reminder. Show them a result they achieved with us that they may have forgotten. Remind them why they signed up.",
      imageSlug: '/images/re-engagement.png',
    },
    {
      word: 'RETENTION RATE',
      partOfSpeech: 'noun',
      definition: "The percentage of customers who continue to buy from or remain subscribed to a company over a given period. The higher the retention rate, the more stable and predictable the revenue. Retention rate is the inverse of churn rate — a company with 4% monthly churn has a 96% monthly retention rate.",
      example: "Riley summarised: Our 12-month retention rate is 61% — meaning nearly 40% of our customers have left within 12 months. Marcus replied: Industry benchmark is 78%. That 17-point gap represents a significant revenue opportunity. Dana added: If we close half that gap — getting to 70% retention — the impact on annual recurring revenue is approximately £2.1 million based on current customer numbers.",
  ...
  phrasalVerbs: [
    {
      ...
      definition: "A phrase for setting a specific churn reduction target. Always give a number — a percentage point reduction, a number of customers retained, or a monetary impact. Used in retention strategy presentations, board meetings, and commercial reviews.",
      example: "Marcus set the target: We need to reduce churn by at least 1.5 percentage points by the end of Q4 — from 4.2% to 2.7%. Riley asked: What is the plan? Marcus replied: Three initiatives — improve the onboarding experience in the first 90 days, launch a proactive check-in programme for customers in the 6 to 18 month danger zone, and build a re-engagement sequence for customers showing early warning signs of disengagement.",
    ...
    },
    {
      ...
      definition: "A phrase for presenting the revenue potential of a specific customer group over the course of their relationship with the company. Always give a number. Used in commercial reviews, retention strategy discussions, and customer segmentation analysis to prioritise which customers to focus resources on.",
      example: "Riley presented the segmentation: The lifetime value of our enterprise customer segment is approximately £18,000 — compared to £2,400 for SME customers. Dana added: That means retaining one enterprise customer is equivalent to retaining 7.5 SME customers in revenue terms. Marcus replied: So our retention investment should be weighted 7.5 to 1 in favour of enterprise — dedicated account managers, proactive check-ins, custom onboarding. The economics justify the cost.",
    ...
    },
    {
      ...
      definition: "A phrase for proposing a targeted communication effort aimed at reactivating customers who have become disengaged. Always specify who the campaign is for and what disengagement signal you are responding to — low usage, email inactivity, or reduced purchase frequency.",
      example: "Dana proposed: We should run a re-engagement campaign for customers who have not logged in for 45 days — there are 600 of them and they represent a significant churn risk. Riley agreed: The campaign should be three messages. The first reminds them of a result they achieved. The second shows them what has changed or improved since they last visited. The third is a direct offer of help — a free strategy call or an onboarding check-in. Marcus added: Do not start with a discount. Start with value. The discount is a last resort.",
    ...
    },
    {
      ...
      definition: "A phrase for presenting insights from Net Promoter Score data. Always follow with a specific finding — a score, a trend, or a pattern in the data. It grounds the loyalty discussion in evidence rather than instinct.",
      example: "Dana presented the NPS analysis: Our NPS shows that the biggest gap is between 6 and 18 months — customers who gave us 9 or 10 in the first three months drop to 6 or 7 by month 12. Marcus replied: That is a classic post-honeymoon effect. Riley added: The Detractors in that cohort are predominantly customers who have not used the full feature set — they are paying for something they are not getting full value from. That is an onboarding problem, not a product problem.",
    ...
    },
    {
      ...
      definition: "A phrase for explaining the strategic purpose of a loyalty programme — not just what the rewards are, but what behaviour it is trying to drive and what outcome it will deliver for the business. Used in programme design, internal presentations, and client briefings.",
      example: "Riley presented the loyalty programme concept: The loyalty programme is designed to drive three things — increase purchase frequency, deepen product engagement, and convert our most satisfied customers into active advocates who refer new customers. Marcus asked: How does the programme structure drive each of those? Riley walked through each tier: Silver drives frequency. Gold deepens engagement through access to advanced features and dedicated support. Platinum converts advocates — co-creation and public case studies give them a stake in our success.",
    ...
    },
    {
      ...
      definition: "A phrase for stating a specific, measurable retention target. Always give the percentage and the timeframe. Used in strategy documents, board presentations, and commercial planning to make the retention goal concrete and trackable.",
      example: "Marcus announced the target: We are targeting a retention rate of 78% at 12 months — up from 61% currently. That is a 17-point improvement and it will not happen overnight. Dana asked: What is the 90-day plan? Marcus replied: Three focus areas — redesign onboarding for the first 90 days, launch proactive check-ins for customers in the danger zone, and run a re-engagement campaign for the disengaged cohort. Riley: We should also look at the exit interview data more carefully — we need to understand the specific reasons customers are leaving before we build the interventions.",
