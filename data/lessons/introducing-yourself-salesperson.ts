...
export const introducingYourselfSalesperson: Lesson = {
  ...
  heroImage: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-hero.png',
  ...
  vocabulary: [
    {
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-contact.png',
    },
    {
      word: 'COMPANY',
      partOfSpeech: 'noun',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-company.png',
    },
    {
      word: 'JOB',
      partOfSpeech: 'noun',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/job.png',
    },
    {
      word: 'TEAM',
      partOfSpeech: 'noun',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-team.png',
    },
    {
      word: 'WORK',
      partOfSpeech: 'verb',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/work.png',
    },
    {
      word: 'MEET',
      partOfSpeech: 'verb',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/meet.png',
    },
    {
      word: 'INTRODUCE',
      partOfSpeech: 'verb',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-introduce.png',
    },
    {
      word: 'COLLEAGUE',
      partOfSpeech: 'noun',
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-colleague.png',
    }
  ],
  ...
  phrasalVerbs: [
    {
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/what-brings-you-here-today.png',
    },
    {
      phrase: 'I WORK FOR',
      definition: 'Tell someone the name of the company you work for.',
      example: 'I work for a software company called Brightline.',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/i-work-for.png',
    },
    {
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/id-love-to-stay-in-touch.png',
    },
    {
      phrase: 'WHAT DO YOU DO',
      definition: "A friendly way to ask about someone's job or company.",
      example: 'So, what do you do, Dana?',
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/introducing-yourself-salesperson-what-do-you-do.png',
    },
    {
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/im-on-the-sales-team.png',
    },
    {
      ...
      imageSlug: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/let-me-introduce-you-to.png',
    }
  ],
  ...
  dialogue: [
    ...
    },
    {
      speaker: 'Carlos',
      speakerColor: 'blue',
      speakerAvatar: 'https://pub-f624871959c1437798bb4e533e0b2adb.r2.dev/sam-icon.png',
  ...
  groupActivities: {
    ...
    "profileMatch": {
        "instructions": "You are Riley. You meet these three contacts in different situations. As a group, decide which introduction style fits each situation best. Use phrases from this lesson to explain your choices. Click 'Check Matches' when you agree.",
        "profiles": [
            {
                "name": 'At a networking event',
                "description": 'You are standing near the coffee table at a business conference. Someone makes eye contact and smiles. You have about 30 seconds before the next session starts.',
                "matchKey": 'quick'
            },
            {
                "name": 'On a scheduled video call',
                "description": "A prospect booked a 30-minute intro call after downloading a Brightline guide. They know who you are and why you're talking. They came prepared.",
                "matchKey": 'product'
            },
            {
                "name": 'Cold outreach follow-up',
                "description": "You sent a short LinkedIn message last week and the contact replied saying they're interested. They don't know much about Brightline yet. You're now calling them for the first time.",
                "matchKey": 'question'
            }
        ],
        "options": [
            {
                ...
                "description": 'Keep it brief: your name, your company, and one sentence about what you do. Then ask a question to get them talking. Best when time is short and the mood is casual.'
            },
            {
                "key": 'product',
                "label": 'Product-led intro',
                "description": "Start with context: who you are at Brightline and how you help customers like them. Move quickly into how the product could be relevant. Best when the contact already knows why they're there."
            },
            {
                "key": 'question',
                "label": 'Question-first intro',
                "description": 'Introduce yourself briefly, then immediately ask an open question about their situation. Shows you are interested in them, not just talking about yourself. Best for cold or warm contacts who need to be engaged.'
            }
        ]
    },
    "finishTheLine": {
