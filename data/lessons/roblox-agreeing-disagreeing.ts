...
export const robloxAgreeingDisagreeing: Lesson = {
  ...
  vocabulary: [
    {
      word: 'DIPLOMATICALLY',
      partOfSpeech: 'adverb',
      definition: "In a tactful, careful way that avoids causing offence — expressing a position without damaging the relationship.",
    ...
    },
    {
      word: 'BLUNTLY',
      partOfSpeech: 'adverb',
      definition: "Directly and honestly, without trying to soften the message — saying exactly what you mean with no cushioning.",
    ...
    },
    {
      word: 'ACKNOWLEDGE',
      partOfSpeech: 'verb',
      definition: "To accept or admit that something is true — recognising a point even if you then argue against its conclusion.",
    ...
    },
    {
      word: 'CONCEDE',
      partOfSpeech: 'verb',
      definition: "To admit that an opposing point is valid or correct — giving ground on one part of an argument while holding your main position.",
    ...
    },
    {
      ...
      definition: "To challenge the truth or validity of something — or a disagreement between parties with opposing views.",
    ...
    },
    {
      word: 'VALID POINT',
      partOfSpeech: 'phrase',
      definition: "An argument or observation that is logically sound and worth considering — even if you disagree with the conclusion.",
    ...
    },
    {
      word: 'FAIR ENOUGH',
      partOfSpeech: 'phrase',
      definition: "Used to accept that something is reasonable — not full agreement, but acknowledgement that the point has merit.",
    ...
    },
    {
      ...
      partOfSpeech: 'phrase',
      definition: "A formal, polite way of saying you disagree with what was just stated — respectful but clear.",
  ...
  irlVocabulary: [
    {
      word: 'DIPLOMATICALLY',
      partOfSpeech: 'adverb',
      definition: "Handling difficult conversations with care — expressing disagreement or criticism without damaging professional relationships.",
    ...
    },
    {
      word: 'BLUNTLY',
      partOfSpeech: 'adverb',
      definition: "Speaking directly without softening — effective when clarity is urgent but risks damaging rapport if overused.",
    ...
    },
    {
      word: 'ACKNOWLEDGE',
      partOfSpeech: 'verb',
      definition: "To formally accept or recognise a point — important in professional discourse for showing you have listened before responding.",
    ...
    },
    {
      word: 'DISPUTE',
      partOfSpeech: 'noun / verb',
      definition: "A formal disagreement between parties — or to challenge the accuracy or validity of a claim.",
    ...
    },
    {
      word: 'VALID POINT',
      partOfSpeech: 'phrase',
      definition: "A logically sound observation that deserves to be addressed — acknowledging it shows professionalism and good faith.",
    ...
    },
    {
      word: 'FAIR ENOUGH',
      partOfSpeech: 'phrase',
      definition: "Used in professional conversation to signal partial acceptance — you are not fully convinced but acknowledge the point has merit.",
    ...
    },
    {
      word: 'I BEG TO DIFFER',
      partOfSpeech: 'phrase',
      definition: "A formal, courteous expression of disagreement — used when you want to be direct without being rude.",
  ...
  phrasalVerbs: [
    {
      ...
      definition: "To maintain your position under pressure — not changing your view even when challenged.",
    ...
    {
      phrase: "COME AROUND",
      definition: "To change your opinion and agree after initially disagreeing — to be persuaded over time.",
    ...
    {
      phrase: "BACK DOWN",
      definition: "To withdraw from a position or stop insisting — to concede when the pressure or evidence is too strong.",
    ...
    {
      phrase: "TALK THROUGH",
      definition: "To discuss something carefully step by step — working toward mutual understanding rather than winning.",
    ...
    {
      phrase: "HEAR OUT",
      definition: "To listen to someone's full argument before responding — giving them the chance to make their case completely.",
    ...
    {
      phrase: "WEIGH UP",
      definition: "To consider arguments, options, or evidence carefully on both sides before reaching a conclusion.",
  ...
  matchingExercise: [
    ...
    { word: 'CONCEDE', definition: 'To admit that an opposing point is valid — giving ground on one part while holding your main position' },
    { word: 'DISPUTE', definition: 'To challenge the truth or validity of something — or a formal disagreement between opposing parties' },
