...
export const gamingEthicsSociety: Lesson = {
  slug: 'gaming-ethics-society',
  title: 'Gaming Ethics & Society',
  subtitle:
    'The hard questions gamers, developers, and critics keep coming back to — monetization, representation, harassment, and who gets to decide what’s acceptable',
  level: 'C1-C2',
  description:
