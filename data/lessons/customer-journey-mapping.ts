  ...
  vocabulary: [
    {
      word: 'TOUCHPOINT',
      partOfSpeech: 'noun',
      definition: 'Any moment when a customer comes into contact with your brand — an ad, a website visit, an email, a social post, or a conversation with your sales team. Every touchpoint is a chance to make a good impression or lose the customer.',
      example: "Marcus said: List every touchpoint in the customer journey — from the first time they see an ad to the moment they sign the contract. Riley replied: I identified eleven touchpoints in total. The weakest ones are the follow-up email after a demo and the onboarding call — customers are dropping out at both of those.",
      imageSlug: '/images/customer-journey-mapping-touchpoint.png',
    },
    {
      word: 'AWARENESS',
      partOfSpeech: 'noun',
      definition: 'The first stage of the customer journey — when the customer discovers or hears about your brand for the first time. At the awareness stage, your goal is to get noticed and be remembered. The customer is not ready to buy yet — they are just learning you exist.',
      example: "Riley explained the map: At the awareness stage, customers are finding us mainly through search and LinkedIn ads. Marcus asked: How many people reach the awareness stage each month? Riley replied: About 12,000 unique visitors see our content each month — that is our top-of-funnel awareness number.",
      imageSlug: '/images/awareness.png',
    },
    {
      word: 'CONSIDERATION',
      partOfSpeech: 'noun',
      definition: 'The stage of the customer journey where the customer knows about your brand and is actively comparing you to other options. They are reading reviews, watching demos, and asking questions. Your goal at this stage is to give them the information they need to choose you.',
      example: "Marcus asked: What content do we have for the consideration stage? Riley replied: Not much — that is the gap. Customers at the consideration stage want to compare products, read case studies, and watch demos. We have good awareness content but almost nothing that helps someone decide between us and a competitor.",
      imageSlug: '/images/consideration.png',
    },
    {
      word: 'CONVERSION',
      partOfSpeech: 'noun',
      definition: 'The moment a customer takes the action you want — buying, signing up, booking a demo, or becoming a paying customer. The conversion rate is the percentage of people who take that action compared to the total who had the opportunity.',
      example: "Riley presented the data: Our conversion rate from trial to paid customer is 18%. Marcus replied: That is below the industry average of 25%. Where does the drop-off happen? Riley answered: Most people who do not convert stop engaging after day seven of the trial. They signed up but never had a proper onboarding session.",
      imageSlug: '/images/customer-journey-mapping-conversion.png',
    },
    {
      word: 'RETENTION',
      partOfSpeech: 'noun',
      definition: "Keeping customers after they have bought from you — making sure they stay, keep using the product, and do not leave for a competitor. Retention is often cheaper than acquiring new customers. A high retention rate means customers are satisfied.",
      example: "Marcus said: Acquisition is only half the story — retention is where the real value is. Riley agreed: Our 12-month retention rate is 74%. The 26% who leave mostly cite the same reason — they felt unsupported after the first month. Improving onboarding could significantly impact retention.",
      imageSlug: '/images/customer-journey-mapping-retention.png',
    },
    {
      word: 'FUNNEL',
      partOfSpeech: 'noun',
      definition: "A visual model of the customer journey that shows how many people move from one stage to the next. It is wide at the top (many people at the awareness stage) and narrow at the bottom (fewer people who actually buy). 'Top of funnel' means early stage, 'bottom of funnel' means close to buying.",
      example: "Riley described the funnel: We have 12,000 people at the top of the funnel each month. By the consideration stage, that drops to 1,400. By conversion, we get around 180 new customers. Marcus said: So the biggest drop-off is between awareness and consideration — that is where we need to focus.",
      imageSlug: '/images/customer-journey-mapping-funnel.png',
    },
    {
      word: 'PERSONA',
      partOfSpeech: 'noun',
      definition: "A fictional but realistic profile of a typical customer — including their job, goals, challenges, and how they make decisions. A persona helps the marketing team create content and messaging that speaks directly to a specific type of customer.",
      example: "Marcus asked: Who are we mapping this journey for? Riley replied: I created three personas — a marketing manager at a mid-size company, a startup founder, and a sales director. Each one has a different journey and different reasons for choosing us. The startup founder converts fastest; the sales director takes the longest.",
      imageSlug: '/images/customer-journey-mapping-persona.png',
    },
    {
      word: 'DROP-OFF',
      partOfSpeech: 'noun',
      definition: "The point in the customer journey where people stop and do not continue to the next stage. A drop-off is a warning sign — it means something is not working at that point. Finding and fixing drop-offs is one of the most valuable things you can do with a customer journey map.",
      example: "Riley highlighted the problem: The biggest drop-off is between the free trial and the paid subscription — 82% of trial users do not convert. Marcus said: That is significant. What happens during the trial period? Riley replied: Most people activate once, never set up the product properly, and then forget about it. There is no guided onboarding.",
  ...
  phrasalVerbs: [
    {
      ...
      definition: 'The standard structure for describing what happens at each point in the customer journey. Always name the stage (awareness, consideration, conversion, retention) and then describe what the customer is thinking, doing, or feeling at that point.',
      example: "Riley presented the map: At the awareness stage, the customer has just discovered us through an ad or a search result — they are curious but not ready to engage. At the consideration stage, the customer is actively comparing us to two or three competitors — they need case studies and a clear comparison page.",
      imageSlug: '/images/at-the-stage-stage.png',
    },
    {
      phrase: 'THE CUSTOMER FIRST ENCOUNTERS THE BRAND WHEN...',
      definition: "A phrase for describing the very first touchpoint in the customer journey — the moment of first contact. 'Encounters' is a professional word for 'meets' or 'comes into contact with'. Always follow it with a specific channel or action.",
      example: "Riley explained: The customer first encounters the brand when they see one of our LinkedIn ads targeting marketing managers. Marcus asked: What happens next? Riley replied: They click through to a blog post — not the homepage. That is the second touchpoint. Most people do not land on the homepage first.",
      imageSlug: '/images/customer-first-encounters.png',
    },
    {
      phrase: 'THE DROP-OFF HAPPENS AT...',
      definition: "A phrase for identifying where customers stop progressing in the funnel. It pinpoints the specific stage or touchpoint where people leave. After identifying the drop-off, the next question is always: why?",
      example: "Riley showed the data: The biggest drop-off happens at day seven of the free trial — 60% of users who are still active on day three have stopped by day seven. Marcus replied: So something specific happens around day seven — or more likely, something that should happen doesn't happen. What is the experience like at that point?",
      imageSlug: '/images/the-drop-off-happens-at.png',
    },
    {
      phrase: 'WE NEED TO IMPROVE THE EXPERIENCE AT...',
      definition: "A phrase for recommending action on a specific part of the customer journey. It identifies a problem stage and signals that a change is needed. Always follow it with a specific stage or touchpoint, not a vague description.",
      example: "Riley concluded: Based on the data, we need to improve the experience at three points — the post-demo follow-up email, the day-seven onboarding check-in, and the first renewal reminder. Marcus agreed: Those are the three highest-impact areas. Fixing all three would significantly improve both conversion and retention.",
      imageSlug: '/images/we-need-to-improve.png',
    },
    {
      phrase: 'EACH TOUCHPOINT SHOULD...',
      definition: "A phrase for setting a standard or expectation for what every customer interaction must do. Use it when designing or reviewing a journey map to make sure every touchpoint has a clear purpose.",
      example: "Marcus set the principle: Each touchpoint should do one of three things — build awareness, move the customer closer to a decision, or strengthen their confidence in the product. Riley replied: That is a useful filter. I'll review every touchpoint in our current map against those three criteria and remove anything that does not do at least one of them.",
      imageSlug: '/images/each-touchpoint-should.png',
    },
    {
      phrase: 'THE GOAL AT THIS STAGE IS TO...',
      definition: "A phrase for stating the marketing objective at a specific point in the funnel. It helps align the team on what success looks like at each stage — which is different at awareness versus conversion versus retention.",
      example: "Riley defined each stage: The goal at the awareness stage is to get the right people to notice us. The goal at the consideration stage is to give them enough information to choose us over a competitor. The goal at the conversion stage is to remove every obstacle between the customer and a purchase decision.",
