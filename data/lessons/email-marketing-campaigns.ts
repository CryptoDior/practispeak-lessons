  ...
  vocabulary: [
    {
      ...
      example: 'The campaign achieved a 34% open rate, which is well above the B2B average of 22%.',
    ...
    },
    {
      ...
      example: 'A high open rate with a low click-through rate means the email was opened but the call to action did not work.',
    ...
    },
    {
      ...
      example: 'The team ran an A/B test on the subject line and the second version had a 40% higher open rate.',
    ...
    },
    {
      ...
      example: 'The drip campaign sends five emails over three weeks to move prospects from awareness to a booked call.',
    ...
    },
    {
      ...
      example: 'An unsubscribe rate above 0.5% is a warning sign that the content is not relevant to the audience.',
    ...
    },
    {
      ...
      example: 'The open rate dropped because of a deliverability problem — the emails were going to spam instead of the inbox.',
    ...
    },
    {
      ...
      example: 'After applying segmentation to separate clients from prospects, the click-through rate on the prospect list doubled.',
    ...
    },
    {
      ...
      example: 'A strong subject line either addresses a pain point, makes a specific promise, or creates genuine curiosity.',
  ...
  phrasalVerbs: [
    {
      ...
      example: 'The team cleans the list every quarter by removing contacts who have not opened an email in six months.',
    ...
    },
    {
      ...
      example: 'A cold list was warmed up with three short emails before the main campaign was sent.',
    ...
    },
    {
      ...
      example: 'The team split tested the call to action button before launching the full campaign.',
    ...
    },
    {
      ...
      example: 'The team always follows up on the first email because most conversions come from the second or third message.',
    ...
    },
    {
      ...
      example: 'Every contact on the list has opted in through a content download or a direct signup form.',
    ...
    },
    {
      ...
      example: 'The team personalises each email by including the recipient\'s company name and the specific sector they work in.',
